...
class PaintPreviewTabServiceJni implements PaintPreviewTabService.Natives {
  ...
  public static final JniStaticTestMocker<PaintPreviewTabService.Natives> TEST_HOOKS = new JniStaticTestMocker<PaintPreviewTabService.Natives>() {
    @Override
    public void setInstanceForTesting(
        PaintPreviewTabService.Natives instance) {
