...
class DownloadUtilsJni implements DownloadUtils.Natives {
  private static DownloadUtils.Natives testInstance;

  public static final JniStaticTestMocker<DownloadUtils.Natives> TEST_HOOKS = new JniStaticTestMocker<DownloadUtils.Natives>() {
    @Override
    public void setInstanceForTesting(
        DownloadUtils.Natives instance) {
