...
class BackgroundSyncBackgroundTaskJni implements BackgroundSyncBackgroundTask.Natives {
  private static BackgroundSyncBackgroundTask.Natives testInstance;

  public static final JniStaticTestMocker<BackgroundSyncBackgroundTask.Natives> TEST_HOOKS = new JniStaticTestMocker<BackgroundSyncBackgroundTask.Natives>() {
    @Override
    public void setInstanceForTesting(
        BackgroundSyncBackgroundTask.Natives instance) {
