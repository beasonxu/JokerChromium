...
public class TemplateUrlServiceJni implements TemplateUrlService.Natives {
  ...
  public static final JniStaticTestMocker<TemplateUrlService.Natives> TEST_HOOKS = new JniStaticTestMocker<TemplateUrlService.Natives>() {
    @Override
    public void setInstanceForTesting(
        TemplateUrlService.Natives instance) {
