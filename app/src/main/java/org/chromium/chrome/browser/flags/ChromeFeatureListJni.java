...
class ChromeFeatureListJni implements ChromeFeatureList.Natives {
  ...
  public static final JniStaticTestMocker<ChromeFeatureList.Natives> TEST_HOOKS = new JniStaticTestMocker<org.chromium.chrome.browser.flags.ChromeFeatureList.Natives>() {
    @Override
