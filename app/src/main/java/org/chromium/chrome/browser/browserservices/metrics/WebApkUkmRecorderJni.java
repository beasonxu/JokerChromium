...
class WebApkUkmRecorderJni implements WebApkUkmRecorder.Natives {
  ...
  public static final JniStaticTestMocker<WebApkUkmRecorder.Natives> TEST_HOOKS = new JniStaticTestMocker<WebApkUkmRecorder.Natives>() {
    @Override
    public void setInstanceForTesting(
        WebApkUkmRecorder.Natives instance) {
