...
class PrefChangeRegistrarJni implements PrefChangeRegistrar.Natives {
  private static PrefChangeRegistrar.Natives testInstance;

  public static final JniStaticTestMocker<PrefChangeRegistrar.Natives> TEST_HOOKS = new JniStaticTestMocker<PrefChangeRegistrar.Natives>() {
    @Override
    public void setInstanceForTesting(
        PrefChangeRegistrar.Natives instance) {
