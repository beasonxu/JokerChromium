...
class PersonalDataManagerJni implements PersonalDataManager.Natives {
  ...
  public static final JniStaticTestMocker<PersonalDataManager.Natives> TEST_HOOKS = new JniStaticTestMocker<PersonalDataManager.Natives>() {
    @Override
    public void setInstanceForTesting(
        PersonalDataManager.Natives instance) {
