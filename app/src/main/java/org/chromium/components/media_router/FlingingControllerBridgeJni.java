...
class FlingingControllerBridgeJni implements FlingingControllerBridge.Natives {
  ...
  public static final JniStaticTestMocker<FlingingControllerBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<FlingingControllerBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        FlingingControllerBridge.Natives instance) {
