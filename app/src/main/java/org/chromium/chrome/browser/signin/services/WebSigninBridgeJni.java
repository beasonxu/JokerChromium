...
class WebSigninBridgeJni implements WebSigninBridge.Natives {
  ...
  public static final JniStaticTestMocker<WebSigninBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<WebSigninBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        WebSigninBridge.Natives instance) {
