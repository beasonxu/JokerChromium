...
class ChromeBackupAgentImplJni implements ChromeBackupAgentImpl.Natives {
  private static ChromeBackupAgentImpl.Natives testInstance;

  public static final JniStaticTestMocker<ChromeBackupAgentImpl.Natives> TEST_HOOKS = new JniStaticTestMocker<ChromeBackupAgentImpl.Natives>() {
    @Override
    public void setInstanceForTesting(
        ChromeBackupAgentImpl.Natives instance) {
