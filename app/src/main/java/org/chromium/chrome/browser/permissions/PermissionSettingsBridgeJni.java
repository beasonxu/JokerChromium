...
public class PermissionSettingsBridgeJni implements PermissionSettingsBridge.Natives {
  ...
  public static final JniStaticTestMocker<PermissionSettingsBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<PermissionSettingsBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        PermissionSettingsBridge.Natives instance) {
