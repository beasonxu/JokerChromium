...
class ContextualSearchManagerJni implements ContextualSearchManager.Natives {
  ...
  public static final JniStaticTestMocker<ContextualSearchManager.Natives> TEST_HOOKS = new JniStaticTestMocker<ContextualSearchManager.Natives>() {
    @Override
    public void setInstanceForTesting(
        ContextualSearchManager.Natives instance) {
