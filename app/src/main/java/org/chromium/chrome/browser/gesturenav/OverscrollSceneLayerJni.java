...
class OverscrollSceneLayerJni implements OverscrollSceneLayer.Natives {
  ...
  public static final JniStaticTestMocker<OverscrollSceneLayer.Natives> TEST_HOOKS = new JniStaticTestMocker<OverscrollSceneLayer.Natives>() {
    @Override
    public void setInstanceForTesting(
        OverscrollSceneLayer.Natives instance) {
