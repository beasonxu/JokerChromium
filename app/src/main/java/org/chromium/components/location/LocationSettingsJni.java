...
class LocationSettingsJni implements LocationSettings.Natives {
  ...
  public static final JniStaticTestMocker<LocationSettings.Natives> TEST_HOOKS = new JniStaticTestMocker<LocationSettings.Natives>() {
    @Override
    public void setInstanceForTesting(
        LocationSettings.Natives instance) {
