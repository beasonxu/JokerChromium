...
class WebApkInstallerJni implements WebApkInstaller.Natives {
  private static WebApkInstaller.Natives testInstance;

  public static final JniStaticTestMocker<WebApkInstaller.Natives> TEST_HOOKS = new JniStaticTestMocker<WebApkInstaller.Natives>() {
    @Override
    public void setInstanceForTesting(
        WebApkInstaller.Natives instance) {
