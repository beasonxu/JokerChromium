...
class TabStripSceneLayerJni implements TabStripSceneLayer.Natives {
  ...
  public static final JniStaticTestMocker<TabStripSceneLayer.Natives> TEST_HOOKS = new JniStaticTestMocker<TabStripSceneLayer.Natives>() {
    @Override
    public void setInstanceForTesting(
        TabStripSceneLayer.Natives instance) {
