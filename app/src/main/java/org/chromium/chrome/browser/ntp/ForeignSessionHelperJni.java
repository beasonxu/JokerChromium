...
class ForeignSessionHelperJni implements ForeignSessionHelper.Natives {
  ...
  public static final JniStaticTestMocker<ForeignSessionHelper.Natives> TEST_HOOKS = new JniStaticTestMocker<ForeignSessionHelper.Natives>() {
    @Override
    public void setInstanceForTesting(
        ForeignSessionHelper.Natives instance) {
