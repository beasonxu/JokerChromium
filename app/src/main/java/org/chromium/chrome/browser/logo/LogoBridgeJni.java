...
public class LogoBridgeJni implements LogoBridge.Natives {
  ...
  public static final JniStaticTestMocker<LogoBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<LogoBridge.Natives>() {
    @Override
    public void setInstanceForTesting(LogoBridge.Natives instance) {
