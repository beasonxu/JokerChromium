...
class CompositorViewImplJni implements CompositorViewImpl.Natives {
  ...
  public static final JniStaticTestMocker<CompositorViewImpl.Natives> TEST_HOOKS = new JniStaticTestMocker<CompositorViewImpl.Natives>() {
    @Override
    public void setInstanceForTesting(
        CompositorViewImpl.Natives instance) {
