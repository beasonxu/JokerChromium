...
class InterceptNavigationDelegateImplJni implements InterceptNavigationDelegateImpl.Natives {
  ...
  public static final JniStaticTestMocker<InterceptNavigationDelegateImpl.Natives> TEST_HOOKS = new JniStaticTestMocker<InterceptNavigationDelegateImpl.Natives>() {
    @Override
    public void setInstanceForTesting(
        InterceptNavigationDelegateImpl.Natives instance) {
