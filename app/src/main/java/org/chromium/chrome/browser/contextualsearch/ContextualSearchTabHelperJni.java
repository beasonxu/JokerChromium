...
class ContextualSearchTabHelperJni implements ContextualSearchTabHelper.Natives {
  ...
  public static final JniStaticTestMocker<ContextualSearchTabHelper.Natives> TEST_HOOKS = new JniStaticTestMocker<ContextualSearchTabHelper.Natives>() {
    @Override
    public void setInstanceForTesting(
        ContextualSearchTabHelper.Natives instance) {
