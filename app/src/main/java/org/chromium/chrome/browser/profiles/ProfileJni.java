...
public class ProfileJni implements Profile.Natives {
  ...
  public static final JniStaticTestMocker<Profile.Natives> TEST_HOOKS = new JniStaticTestMocker<Profile.Natives>() {
    @Override
    public void setInstanceForTesting(Profile.Natives instance) {
