...
public class ManagedBrowserUtilsJni implements ManagedBrowserUtils.Natives {
  ...
  public static final JniStaticTestMocker<ManagedBrowserUtils.Natives> TEST_HOOKS = new JniStaticTestMocker<ManagedBrowserUtils.Natives>() {
    @Override
    public void setInstanceForTesting(
        ManagedBrowserUtils.Natives instance) {
