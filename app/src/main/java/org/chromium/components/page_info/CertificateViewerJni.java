...
class CertificateViewerJni implements CertificateViewer.Natives {
  ...
  public static final JniStaticTestMocker<CertificateViewer.Natives> TEST_HOOKS = new JniStaticTestMocker<CertificateViewer.Natives>() {
    @Override
    public void setInstanceForTesting(
        CertificateViewer.Natives instance) {
