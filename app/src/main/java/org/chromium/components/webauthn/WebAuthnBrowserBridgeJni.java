...
class WebAuthnBrowserBridgeJni implements WebAuthnBrowserBridge.Natives {
  ...
  public static final JniStaticTestMocker<WebAuthnBrowserBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<WebAuthnBrowserBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        WebAuthnBrowserBridge.Natives instance) {
