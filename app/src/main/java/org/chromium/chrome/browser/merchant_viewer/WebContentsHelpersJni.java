...
public class WebContentsHelpersJni implements WebContentsHelpers.Natives {
  ...
  public static final JniStaticTestMocker<WebContentsHelpers.Natives> TEST_HOOKS = new JniStaticTestMocker<WebContentsHelpers.Natives>() {
    @Override
    public void setInstanceForTesting(
        WebContentsHelpers.Natives instance) {
