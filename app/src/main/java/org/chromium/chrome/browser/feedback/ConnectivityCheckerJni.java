...
class ConnectivityCheckerJni implements ConnectivityChecker.Natives {
  ...
  public static final JniStaticTestMocker<ConnectivityChecker.Natives> TEST_HOOKS = new JniStaticTestMocker<ConnectivityChecker.Natives>() {
    @Override
    public void setInstanceForTesting(
        ConnectivityChecker.Natives instance) {
