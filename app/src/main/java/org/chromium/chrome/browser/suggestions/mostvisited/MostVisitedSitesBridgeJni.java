...
class MostVisitedSitesBridgeJni implements MostVisitedSitesBridge.Natives {
  ...
  public static final JniStaticTestMocker<MostVisitedSitesBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<MostVisitedSitesBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        MostVisitedSitesBridge.Natives instance) {
