...
class WebApkUpdateDataFetcherJni implements WebApkUpdateDataFetcher.Natives {
  ...
  public static final JniStaticTestMocker<WebApkUpdateDataFetcher.Natives> TEST_HOOKS = new JniStaticTestMocker<WebApkUpdateDataFetcher.Natives>() {
    @Override
    public void setInstanceForTesting(
        WebApkUpdateDataFetcher.Natives instance) {
