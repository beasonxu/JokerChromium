...
class AndroidNetworkLibrary {
    ...
    private static boolean getIsCaptivePortal() {
        ...
        // later versions.
        if (Build.VERSION.SDK_INT < VERSION_CODES.M) return false;
        ConnectivityManager connectivityManager =
                (ConnectivityManager) ContextUtils.getApplicationContext().getSystemService(
                        Context.CONNECTIVITY_SERVICE);
    ...
    /**
     * This class provides an implementation of {@link Socket} that serves only as a
     * conduit to pass a file descriptor integer to {@link TrafficStats#tagSocket}
    ...
    private static class SocketFd extends Socket {
        /**
         * This class provides an implementation of {@link SocketImpl} that serves only as
         * a conduit to pass a file descriptor integer to {@link TrafficStats#tagSocket}
        ...
        private static class SocketImplFd extends SocketImpl {
            /**
             * Create a {@link SocketImpl} that sets {@code fd} as the underlying file
        ...
        /**
         * Create a {@link Socket} that sets {@code fd} as the underlying file
         * descriptor. Does not take ownership of the file descriptor, so calling {@link #close}
         * will not actually close the file descriptor.
         */
