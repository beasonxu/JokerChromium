...
class ContentUtilsJni implements ContentUtils.Natives {
  private static ContentUtils.Natives testInstance;

  public static final JniStaticTestMocker<ContentUtils.Natives> TEST_HOOKS = new JniStaticTestMocker<ContentUtils.Natives>() {
    @Override
    public void setInstanceForTesting(
        ContentUtils.Natives instance) {
