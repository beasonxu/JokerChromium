...
class PermissionUpdateRequesterJni implements PermissionUpdateRequester.Natives {
  ...
  public static final JniStaticTestMocker<PermissionUpdateRequester.Natives> TEST_HOOKS = new JniStaticTestMocker<PermissionUpdateRequester.Natives>() {
    @Override
    public void setInstanceForTesting(
        PermissionUpdateRequester.Natives instance) {
