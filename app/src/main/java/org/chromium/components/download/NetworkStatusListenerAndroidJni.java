...
class NetworkStatusListenerAndroidJni implements NetworkStatusListenerAndroid.Natives {
  ...
  public static final JniStaticTestMocker<NetworkStatusListenerAndroid.Natives> TEST_HOOKS = new JniStaticTestMocker<NetworkStatusListenerAndroid.Natives>() {
    @Override
    public void setInstanceForTesting(
        NetworkStatusListenerAndroid.Natives instance) {
