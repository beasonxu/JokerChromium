...
class CookieControlsBridgeJni implements CookieControlsBridge.Natives {
  ...
  public static final JniStaticTestMocker<CookieControlsBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<CookieControlsBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        CookieControlsBridge.Natives instance) {
