...
class ToolbarSwipeSceneLayerJni implements ToolbarSwipeSceneLayer.Natives {
  ...
  public static final JniStaticTestMocker<ToolbarSwipeSceneLayer.Natives> TEST_HOOKS = new JniStaticTestMocker<ToolbarSwipeSceneLayer.Natives>() {
    @Override
    public void setInstanceForTesting(
        ToolbarSwipeSceneLayer.Natives instance) {
