...
public class LensPolicyUtilsJni implements LensPolicyUtils.Natives {
  ...
  public static final JniStaticTestMocker<LensPolicyUtils.Natives> TEST_HOOKS = new JniStaticTestMocker<LensPolicyUtils.Natives>() {
    @Override
    public void setInstanceForTesting(
        LensPolicyUtils.Natives instance) {
