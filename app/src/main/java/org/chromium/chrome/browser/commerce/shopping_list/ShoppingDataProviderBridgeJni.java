...
class ShoppingDataProviderBridgeJni implements ShoppingDataProviderBridge.Natives {
  ...
  public static final JniStaticTestMocker<ShoppingDataProviderBridge.Natives> TEST_HOOKS = new org.chromium.base.JniStaticTestMocker<org.chromium.chrome.browser.commerce.shopping_list.ShoppingDataProviderBridge.Natives>() {
    @java.lang.Override
    public void setInstanceForTesting(
        org.chromium.chrome.browser.commerce.shopping_list.ShoppingDataProviderBridge.Natives instance) {
