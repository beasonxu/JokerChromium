...
public class PerformanceHintsObserverJni implements PerformanceHintsObserver.Natives {
  ...
  public static final JniStaticTestMocker<PerformanceHintsObserver.Natives> TEST_HOOKS = new JniStaticTestMocker<PerformanceHintsObserver.Natives>() {
    @Override
    public void setInstanceForTesting(
        PerformanceHintsObserver.Natives instance) {
