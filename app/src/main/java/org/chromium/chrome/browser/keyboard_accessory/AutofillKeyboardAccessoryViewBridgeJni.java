...
class AutofillKeyboardAccessoryViewBridgeJni implements AutofillKeyboardAccessoryViewBridge.Natives {
  ...
  public static final JniStaticTestMocker<AutofillKeyboardAccessoryViewBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<AutofillKeyboardAccessoryViewBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        AutofillKeyboardAccessoryViewBridge.Natives instance) {
