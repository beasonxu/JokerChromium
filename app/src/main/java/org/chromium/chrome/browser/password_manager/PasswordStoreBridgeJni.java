...
class PasswordStoreBridgeJni implements PasswordStoreBridge.Natives {
  ...
  public static final JniStaticTestMocker<PasswordStoreBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<PasswordStoreBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        PasswordStoreBridge.Natives instance) {
