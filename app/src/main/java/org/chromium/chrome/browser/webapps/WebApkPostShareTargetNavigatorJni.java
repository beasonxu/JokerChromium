...
public class WebApkPostShareTargetNavigatorJni implements WebApkPostShareTargetNavigator.Natives {
  ...
  public static final JniStaticTestMocker<WebApkPostShareTargetNavigator.Natives> TEST_HOOKS = new JniStaticTestMocker<WebApkPostShareTargetNavigator.Natives>() {
    @Override
    public void setInstanceForTesting(
        WebApkPostShareTargetNavigator.Natives instance) {
