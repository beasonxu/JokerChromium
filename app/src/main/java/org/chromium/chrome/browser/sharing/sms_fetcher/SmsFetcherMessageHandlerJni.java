...
class SmsFetcherMessageHandlerJni implements SmsFetcherMessageHandler.Natives {
  ...
  public static final JniStaticTestMocker<SmsFetcherMessageHandler.Natives> TEST_HOOKS = new JniStaticTestMocker<SmsFetcherMessageHandler.Natives>() {
    @Override
    public void setInstanceForTesting(
        SmsFetcherMessageHandler.Natives instance) {
