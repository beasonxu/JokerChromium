...
class TabWebContentsDelegateAndroidImplJni implements TabWebContentsDelegateAndroidImpl.Natives {
  private static TabWebContentsDelegateAndroidImpl.Natives testInstance;

  public static final JniStaticTestMocker<TabWebContentsDelegateAndroidImpl.Natives> TEST_HOOKS = new JniStaticTestMocker<TabWebContentsDelegateAndroidImpl.Natives>() {
    @Override
    public void setInstanceForTesting(
        TabWebContentsDelegateAndroidImpl.Natives instance) {
