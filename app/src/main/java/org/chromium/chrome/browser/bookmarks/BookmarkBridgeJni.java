...
class BookmarkBridgeJni implements BookmarkBridge.Natives {
  ...
  public static final JniStaticTestMocker<BookmarkBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<BookmarkBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        BookmarkBridge.Natives instance) {
