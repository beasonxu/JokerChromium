...
public interface PowerBookmarkMetaOrBuilder extends
   ...
   */
  org.chromium.chrome.browser.power_bookmarks.PowerBookmarkMeta.Image getLeadImage();
   ...
   */
  java.util.List<org.chromium.chrome.browser.power_bookmarks.PowerBookmarkMeta.Image> 
   ...
   * <code>repeated .power_bookmarks.PowerBookmarkMeta.Image fallback_images = 2;</code>
   */
  org.chromium.chrome.browser.power_bookmarks.PowerBookmarkMeta.Image getFallbackImages(int index);
  /**
   * <pre>
   * Fallback images are made available for future edits or if the lead is
   * unavailable.
   ...
   */
  java.util.List<org.chromium.chrome.browser.power_bookmarks.PowerBookmarkMeta.Tag> 
      getTagsList();
  /**
   * <code>repeated .power_bookmarks.PowerBookmarkMeta.Tag tags = 3;</code>
   */
  org.chromium.chrome.browser.power_bookmarks.PowerBookmarkMeta.Tag getTags(int index);
  /**
   * <code>repeated .power_bookmarks.PowerBookmarkMeta.Tag tags = 3;</code>
   */
  int getTagsCount();
   ...
   * @return The type.
   */
  org.chromium.chrome.browser.power_bookmarks.PowerBookmarkType getType();
   ...
   */
  org.chromium.chrome.browser.power_bookmarks.ShoppingSpecifics getShoppingSpecifics();

  public org.chromium.chrome.browser.power_bookmarks.PowerBookmarkMeta.TypeSpecificsCase getTypeSpecificsCase();
}
