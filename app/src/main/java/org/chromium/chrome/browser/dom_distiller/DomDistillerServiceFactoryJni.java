...
class DomDistillerServiceFactoryJni implements DomDistillerServiceFactory.Natives {
  ...
  public static final JniStaticTestMocker<DomDistillerServiceFactory.Natives> TEST_HOOKS = new JniStaticTestMocker<DomDistillerServiceFactory.Natives>() {
    @Override
    public void setInstanceForTesting(
        DomDistillerServiceFactory.Natives instance) {
