...
class InstalledWebappGeolocationBridgeJni implements InstalledWebappGeolocationBridge.Natives {
  ...
  public static final JniStaticTestMocker<InstalledWebappGeolocationBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<InstalledWebappGeolocationBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        InstalledWebappGeolocationBridge.Natives instance) {
