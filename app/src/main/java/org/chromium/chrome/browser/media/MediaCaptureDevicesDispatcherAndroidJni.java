...
class MediaCaptureDevicesDispatcherAndroidJni implements MediaCaptureDevicesDispatcherAndroid.Natives {
  ...
  public static final JniStaticTestMocker<MediaCaptureDevicesDispatcherAndroid.Natives> TEST_HOOKS = new JniStaticTestMocker<MediaCaptureDevicesDispatcherAndroid.Natives>() {
    @Override
    public void setInstanceForTesting(
        MediaCaptureDevicesDispatcherAndroid.Natives instance) {
