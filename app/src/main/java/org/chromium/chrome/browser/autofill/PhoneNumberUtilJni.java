...
class PhoneNumberUtilJni implements PhoneNumberUtil.Natives {
  ...
  public static final JniStaticTestMocker<PhoneNumberUtil.Natives> TEST_HOOKS = new JniStaticTestMocker<PhoneNumberUtil.Natives>() {
    @Override
    public void setInstanceForTesting(
        PhoneNumberUtil.Natives instance) {
