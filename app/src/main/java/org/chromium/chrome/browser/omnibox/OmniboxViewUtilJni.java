...
class OmniboxViewUtilJni implements OmniboxViewUtil.Natives {
  private static OmniboxViewUtil.Natives testInstance;

  public static final JniStaticTestMocker<OmniboxViewUtil.Natives> TEST_HOOKS = new JniStaticTestMocker<OmniboxViewUtil.Natives>() {
    @Override
    public void setInstanceForTesting(
        OmniboxViewUtil.Natives instance) {
