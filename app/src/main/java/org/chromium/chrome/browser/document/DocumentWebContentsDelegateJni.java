...
class DocumentWebContentsDelegateJni implements DocumentWebContentsDelegate.Natives {
  private static DocumentWebContentsDelegate.Natives testInstance;

  public static final JniStaticTestMocker<DocumentWebContentsDelegate.Natives> TEST_HOOKS = new JniStaticTestMocker<DocumentWebContentsDelegate.Natives>() {
    @Override
    public void setInstanceForTesting(
        DocumentWebContentsDelegate.Natives instance) {
