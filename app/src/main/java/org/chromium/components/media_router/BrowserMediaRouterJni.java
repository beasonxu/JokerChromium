...
class BrowserMediaRouterJni implements BrowserMediaRouter.Natives {
  ...
  public static final JniStaticTestMocker<BrowserMediaRouter.Natives> TEST_HOOKS = new JniStaticTestMocker<BrowserMediaRouter.Natives>() {
    @Override
    public void setInstanceForTesting(
        BrowserMediaRouter.Natives instance) {
