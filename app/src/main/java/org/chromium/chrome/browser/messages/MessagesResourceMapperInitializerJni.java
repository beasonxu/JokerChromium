...
class MessagesResourceMapperInitializerJni implements MessagesResourceMapperInitializer.Natives {
  ...
  public static final JniStaticTestMocker<MessagesResourceMapperInitializer.Natives> TEST_HOOKS = new JniStaticTestMocker<MessagesResourceMapperInitializer.Natives>() {
    @Override
    public void setInstanceForTesting(
        MessagesResourceMapperInitializer.Natives instance) {
