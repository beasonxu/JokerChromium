...
class ChromeHttpAuthHandlerJni implements ChromeHttpAuthHandler.Natives {
  ...
  public static final JniStaticTestMocker<ChromeHttpAuthHandler.Natives> TEST_HOOKS = new JniStaticTestMocker<ChromeHttpAuthHandler.Natives>() {
    @Override
    public void setInstanceForTesting(
        ChromeHttpAuthHandler.Natives instance) {
