...
class StatusIndicatorSceneLayerJni implements StatusIndicatorSceneLayer.Natives {
  ...
  public static final JniStaticTestMocker<StatusIndicatorSceneLayer.Natives> TEST_HOOKS = new JniStaticTestMocker<StatusIndicatorSceneLayer.Natives>() {
    @Override
    public void setInstanceForTesting(
        StatusIndicatorSceneLayer.Natives instance) {
