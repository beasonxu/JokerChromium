...
class BackgroundSyncBackgroundTaskSchedulerJni implements BackgroundSyncBackgroundTaskScheduler.Natives {
  private static BackgroundSyncBackgroundTaskScheduler.Natives testInstance;

  public static final JniStaticTestMocker<BackgroundSyncBackgroundTaskScheduler.Natives> TEST_HOOKS = new JniStaticTestMocker<BackgroundSyncBackgroundTaskScheduler.Natives>() {
    @Override
    public void setInstanceForTesting(
        BackgroundSyncBackgroundTaskScheduler.Natives instance) {
