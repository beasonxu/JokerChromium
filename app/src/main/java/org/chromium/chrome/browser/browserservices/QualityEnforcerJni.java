...
class QualityEnforcerJni implements QualityEnforcer.Natives {
  ...
  public static final JniStaticTestMocker<QualityEnforcer.Natives> TEST_HOOKS = new JniStaticTestMocker<QualityEnforcer.Natives>() {
    @Override
    public void setInstanceForTesting(
        QualityEnforcer.Natives instance) {
