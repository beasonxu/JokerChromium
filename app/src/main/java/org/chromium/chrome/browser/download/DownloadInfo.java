...
public final class DownloadInfo {
    ...
    /**
     * Helper method to build a {@link Builder} from an {@link OfflineItem}.
     * @param item    The {@link OfflineItem} to mimic.
     * @param visuals The {@link OfflineItemVisuals} to mimic.
     * @return        A {@link Builder} containing the relevant fields from
     *                {@code item}.
     */
    public static Builder builderFromOfflineItem(
