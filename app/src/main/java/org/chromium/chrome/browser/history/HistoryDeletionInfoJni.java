...
class HistoryDeletionInfoJni implements HistoryDeletionInfo.Natives {
  ...
  public static final JniStaticTestMocker<HistoryDeletionInfo.Natives> TEST_HOOKS = new JniStaticTestMocker<HistoryDeletionInfo.Natives>() {
    @Override
    public void setInstanceForTesting(
        HistoryDeletionInfo.Natives instance) {
