...
class ExploreSitesBridgeJni implements ExploreSitesBridge.Natives {
  private static ExploreSitesBridge.Natives testInstance;

  public static final JniStaticTestMocker<ExploreSitesBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<ExploreSitesBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        ExploreSitesBridge.Natives instance) {
