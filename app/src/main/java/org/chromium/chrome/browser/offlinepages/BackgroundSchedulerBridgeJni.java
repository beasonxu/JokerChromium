...
class BackgroundSchedulerBridgeJni implements BackgroundSchedulerBridge.Natives {
  ...
  public static final JniStaticTestMocker<BackgroundSchedulerBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<BackgroundSchedulerBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        BackgroundSchedulerBridge.Natives instance) {
