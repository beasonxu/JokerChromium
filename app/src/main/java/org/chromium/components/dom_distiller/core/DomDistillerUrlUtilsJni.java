...
public class DomDistillerUrlUtilsJni implements DomDistillerUrlUtils.Natives {
  ...
  public static final JniStaticTestMocker<DomDistillerUrlUtils.Natives> TEST_HOOKS = new JniStaticTestMocker<DomDistillerUrlUtils.Natives>() {
    @Override
    public void setInstanceForTesting(
        DomDistillerUrlUtils.Natives instance) {
