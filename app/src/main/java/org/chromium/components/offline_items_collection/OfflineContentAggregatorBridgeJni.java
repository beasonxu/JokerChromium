...
class OfflineContentAggregatorBridgeJni implements OfflineContentAggregatorBridge.Natives {
  ...
  public static final JniStaticTestMocker<OfflineContentAggregatorBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<OfflineContentAggregatorBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        OfflineContentAggregatorBridge.Natives instance) {
