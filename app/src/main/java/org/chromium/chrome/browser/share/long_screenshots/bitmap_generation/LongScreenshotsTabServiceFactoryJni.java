...
class LongScreenshotsTabServiceFactoryJni implements LongScreenshotsTabServiceFactory.Natives {
  private static LongScreenshotsTabServiceFactory.Natives testInstance;

  public static final JniStaticTestMocker<LongScreenshotsTabServiceFactory.Natives> TEST_HOOKS = new JniStaticTestMocker<LongScreenshotsTabServiceFactory.Natives>() {
    @Override
    public void setInstanceForTesting(
        LongScreenshotsTabServiceFactory.Natives instance) {
