...
class NavigationPredictorBridgeJni implements NavigationPredictorBridge.Natives {
  private static NavigationPredictorBridge.Natives testInstance;

  public static final JniStaticTestMocker<NavigationPredictorBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<NavigationPredictorBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        NavigationPredictorBridge.Natives instance) {
