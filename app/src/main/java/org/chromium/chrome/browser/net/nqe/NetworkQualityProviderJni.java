...
class NetworkQualityProviderJni implements NetworkQualityProvider.Natives {
  private static NetworkQualityProvider.Natives testInstance;

  public static final JniStaticTestMocker<NetworkQualityProvider.Natives> TEST_HOOKS = new JniStaticTestMocker<NetworkQualityProvider.Natives>() {
    @Override
    public void setInstanceForTesting(
        NetworkQualityProvider.Natives instance) {
