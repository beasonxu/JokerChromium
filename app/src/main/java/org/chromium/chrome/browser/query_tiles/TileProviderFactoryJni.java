...
class TileProviderFactoryJni implements TileProviderFactory.Natives {
  ...
  public static final JniStaticTestMocker<TileProviderFactory.Natives> TEST_HOOKS = new JniStaticTestMocker<TileProviderFactory.Natives>() {
    @Override
    public void setInstanceForTesting(
        TileProviderFactory.Natives instance) {
