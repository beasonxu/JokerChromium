...
public class SecurityStateModelJni implements SecurityStateModel.Natives {
  ...
  public static final JniStaticTestMocker<SecurityStateModel.Natives> TEST_HOOKS = new JniStaticTestMocker<SecurityStateModel.Natives>() {
    @Override
    public void setInstanceForTesting(
        SecurityStateModel.Natives instance) {
