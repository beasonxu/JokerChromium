...
class ModuleJni implements Module.Natives {
  private static Module.Natives testInstance;

  public static final JniStaticTestMocker<Module.Natives> TEST_HOOKS = new JniStaticTestMocker<Module.Natives>() {
    @Override
    public void setInstanceForTesting(
        Module.Natives instance) {
