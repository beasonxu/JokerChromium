...
class NotificationPlatformBridgeJni implements NotificationPlatformBridge.Natives {
  ...
  public static final JniStaticTestMocker<NotificationPlatformBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<NotificationPlatformBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        NotificationPlatformBridge.Natives instance) {
