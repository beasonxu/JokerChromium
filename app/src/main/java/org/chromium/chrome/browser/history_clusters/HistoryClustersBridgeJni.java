...
class HistoryClustersBridgeJni implements HistoryClustersBridge.Natives {
  ...
  public static final JniStaticTestMocker<HistoryClustersBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<HistoryClustersBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        HistoryClustersBridge.Natives instance) {
