...
class SurveyHttpClientBridgeJni implements SurveyHttpClientBridge.Natives {
  ...
  public static final JniStaticTestMocker<SurveyHttpClientBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<SurveyHttpClientBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        SurveyHttpClientBridge.Natives instance) {
