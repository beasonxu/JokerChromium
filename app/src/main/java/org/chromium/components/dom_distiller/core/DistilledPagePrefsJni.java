...
class DistilledPagePrefsJni implements DistilledPagePrefs.Natives {
  ...
  public static final JniStaticTestMocker<DistilledPagePrefs.Natives> TEST_HOOKS = new JniStaticTestMocker<DistilledPagePrefs.Natives>() {
    @Override
    public void setInstanceForTesting(
        DistilledPagePrefs.Natives instance) {
