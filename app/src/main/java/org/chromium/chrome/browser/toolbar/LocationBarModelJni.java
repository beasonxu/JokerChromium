...
class LocationBarModelJni implements LocationBarModel.Natives {
  private static LocationBarModel.Natives testInstance;

  public static final JniStaticTestMocker<LocationBarModel.Natives> TEST_HOOKS = new JniStaticTestMocker<LocationBarModel.Natives>() {
    @Override
    public void setInstanceForTesting(
        LocationBarModel.Natives instance) {
