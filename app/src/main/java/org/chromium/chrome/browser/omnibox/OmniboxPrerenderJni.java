...
class OmniboxPrerenderJni implements OmniboxPrerender.Natives {
  ...
  public static final JniStaticTestMocker<OmniboxPrerender.Natives> TEST_HOOKS = new JniStaticTestMocker<OmniboxPrerender.Natives>() {
    @Override
    public void setInstanceForTesting(
        OmniboxPrerender.Natives instance) {
