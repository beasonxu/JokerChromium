...
class PasswordSettingsUpdaterBridgeJni implements PasswordSettingsUpdaterBridge.Natives {
  ...
  public static final JniStaticTestMocker<PasswordSettingsUpdaterBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<PasswordSettingsUpdaterBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        PasswordSettingsUpdaterBridge.Natives instance) {
