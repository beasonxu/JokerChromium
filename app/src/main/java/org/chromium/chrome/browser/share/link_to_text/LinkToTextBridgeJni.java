...
class LinkToTextBridgeJni implements LinkToTextBridge.Natives {
  ...
  public static final JniStaticTestMocker<LinkToTextBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<LinkToTextBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        LinkToTextBridge.Natives instance) {
