...
class MessageWrapperJni implements MessageWrapper.Natives {
  ...
  public static final JniStaticTestMocker<MessageWrapper.Natives> TEST_HOOKS = new JniStaticTestMocker<MessageWrapper.Natives>() {
    @Override
    public void setInstanceForTesting(
        MessageWrapper.Natives instance) {
