...
public class LevelDBPersistedDataStorageJni implements LevelDBPersistedDataStorage.Natives {
  ...
  public static final JniStaticTestMocker<LevelDBPersistedDataStorage.Natives> TEST_HOOKS = new JniStaticTestMocker<LevelDBPersistedDataStorage.Natives>() {
    @Override
    public void setInstanceForTesting(
        LevelDBPersistedDataStorage.Natives instance) {
