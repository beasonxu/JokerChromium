...
class AdsBlockedDialogJni implements AdsBlockedDialog.Natives {
  ...
  public static final JniStaticTestMocker<AdsBlockedDialog.Natives> TEST_HOOKS = new JniStaticTestMocker<AdsBlockedDialog.Natives>() {
    @Override
    public void setInstanceForTesting(
        AdsBlockedDialog.Natives instance) {
