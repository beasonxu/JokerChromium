...
class FindInPageBridgeJni implements FindInPageBridge.Natives {
  private static FindInPageBridge.Natives testInstance;

  public static final JniStaticTestMocker<FindInPageBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<FindInPageBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        FindInPageBridge.Natives instance) {
