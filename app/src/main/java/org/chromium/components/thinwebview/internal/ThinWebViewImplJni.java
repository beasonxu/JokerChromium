...
class ThinWebViewImplJni implements ThinWebViewImpl.Natives {
  ...
  public static final JniStaticTestMocker<ThinWebViewImpl.Natives> TEST_HOOKS = new JniStaticTestMocker<ThinWebViewImpl.Natives>() {
    @Override
    public void setInstanceForTesting(
        ThinWebViewImpl.Natives instance) {
