...
class WarmupManagerJni implements WarmupManager.Natives {
  ...
  public static final JniStaticTestMocker<WarmupManager.Natives> TEST_HOOKS = new JniStaticTestMocker<WarmupManager.Natives>() {
    @Override
    public void setInstanceForTesting(WarmupManager.Natives instance) {
