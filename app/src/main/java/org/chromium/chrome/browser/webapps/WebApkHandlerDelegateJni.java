...
class WebApkHandlerDelegateJni implements WebApkHandlerDelegate.Natives {
  ...
  public static final JniStaticTestMocker<WebApkHandlerDelegate.Natives> TEST_HOOKS = new JniStaticTestMocker<WebApkHandlerDelegate.Natives>() {
    @Override
    public void setInstanceForTesting(
        WebApkHandlerDelegate.Natives instance) {
