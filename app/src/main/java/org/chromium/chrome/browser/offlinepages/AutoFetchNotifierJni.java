...
class AutoFetchNotifierJni implements AutoFetchNotifier.Natives {
  private static AutoFetchNotifier.Natives testInstance;

  public static final JniStaticTestMocker<AutoFetchNotifier.Natives> TEST_HOOKS = new JniStaticTestMocker<AutoFetchNotifier.Natives>() {
    @Override
    public void setInstanceForTesting(
        AutoFetchNotifier.Natives instance) {
