...
public class PictureInPictureActivityJni implements PictureInPictureActivity.Natives {
  ...
  public static final JniStaticTestMocker<PictureInPictureActivity.Natives> TEST_HOOKS = new JniStaticTestMocker<PictureInPictureActivity.Natives>() {
    @Override
    public void setInstanceForTesting(
        PictureInPictureActivity.Natives instance) {
