...
class StringUtilsJni implements StringUtils.Natives {
  private static StringUtils.Natives testInstance;

  public static final JniStaticTestMocker<StringUtils.Natives> TEST_HOOKS = new JniStaticTestMocker<StringUtils.Natives>() {
    @Override
    public void setInstanceForTesting(
        StringUtils.Natives instance) {
