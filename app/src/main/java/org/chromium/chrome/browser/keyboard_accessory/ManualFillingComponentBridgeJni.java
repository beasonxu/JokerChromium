...
class ManualFillingComponentBridgeJni implements ManualFillingComponentBridge.Natives {
  ...
  public static final JniStaticTestMocker<ManualFillingComponentBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<ManualFillingComponentBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        ManualFillingComponentBridge.Natives instance) {
