...
class BrowsingHistoryBridgeJni implements BrowsingHistoryBridge.Natives {
  ...
  public static final JniStaticTestMocker<BrowsingHistoryBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<BrowsingHistoryBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        BrowsingHistoryBridge.Natives instance) {
