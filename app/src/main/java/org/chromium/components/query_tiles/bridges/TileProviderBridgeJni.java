...
class TileProviderBridgeJni implements TileProviderBridge.Natives {
  ...
  public static final JniStaticTestMocker<TileProviderBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<TileProviderBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        TileProviderBridge.Natives instance) {
