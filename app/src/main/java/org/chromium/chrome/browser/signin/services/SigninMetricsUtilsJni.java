...
public class SigninMetricsUtilsJni implements SigninMetricsUtils.Natives {
  ...
  public static final JniStaticTestMocker<SigninMetricsUtils.Natives> TEST_HOOKS = new JniStaticTestMocker<SigninMetricsUtils.Natives>() {
    @Override
    public void setInstanceForTesting(
        SigninMetricsUtils.Natives instance) {
