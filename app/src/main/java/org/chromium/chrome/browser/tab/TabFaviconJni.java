...
class TabFaviconJni implements TabFavicon.Natives {
  ...
  public static final JniStaticTestMocker<TabFavicon.Natives> TEST_HOOKS = new JniStaticTestMocker<TabFavicon.Natives>() {
    @Override
    public void setInstanceForTesting(TabFavicon.Natives instance) {
