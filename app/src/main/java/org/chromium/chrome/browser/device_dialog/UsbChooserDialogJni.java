...
class UsbChooserDialogJni implements UsbChooserDialog.Natives {
  ...
  public static final JniStaticTestMocker<UsbChooserDialog.Natives> TEST_HOOKS = new JniStaticTestMocker<UsbChooserDialog.Natives>() {
    @Override
    public void setInstanceForTesting(
        UsbChooserDialog.Natives instance) {
