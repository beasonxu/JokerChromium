...
class PeriodicBackgroundSyncChromeWakeUpTaskJni implements PeriodicBackgroundSyncChromeWakeUpTask.Natives {
  ...
  public static final JniStaticTestMocker<PeriodicBackgroundSyncChromeWakeUpTask.Natives> TEST_HOOKS = new JniStaticTestMocker<PeriodicBackgroundSyncChromeWakeUpTask.Natives>() {
    @Override
    public void setInstanceForTesting(
        PeriodicBackgroundSyncChromeWakeUpTask.Natives instance) {
