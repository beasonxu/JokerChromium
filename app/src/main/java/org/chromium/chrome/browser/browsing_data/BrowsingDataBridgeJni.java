...
class BrowsingDataBridgeJni implements BrowsingDataBridge.Natives {
  ...
  public static final JniStaticTestMocker<BrowsingDataBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<BrowsingDataBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        BrowsingDataBridge.Natives instance) {
