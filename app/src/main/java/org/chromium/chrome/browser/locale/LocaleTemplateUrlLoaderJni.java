...
class LocaleTemplateUrlLoaderJni implements LocaleTemplateUrlLoader.Natives {
  ...
  public static final JniStaticTestMocker<LocaleTemplateUrlLoader.Natives> TEST_HOOKS = new JniStaticTestMocker<LocaleTemplateUrlLoader.Natives>() {
    @Override
    public void setInstanceForTesting(
        LocaleTemplateUrlLoader.Natives instance) {
