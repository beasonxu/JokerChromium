...
class SimpleConfirmInfoBarBuilderJni implements SimpleConfirmInfoBarBuilder.Natives {
  ...
  public static final JniStaticTestMocker<SimpleConfirmInfoBarBuilder.Natives> TEST_HOOKS = new JniStaticTestMocker<SimpleConfirmInfoBarBuilder.Natives>() {
    @Override
    public void setInstanceForTesting(
        SimpleConfirmInfoBarBuilder.Natives instance) {
