...
class CompositorViewJni implements CompositorView.Natives {
  ...
  public static final JniStaticTestMocker<CompositorView.Natives> TEST_HOOKS = new JniStaticTestMocker<CompositorView.Natives>() {
    @Override
    public void setInstanceForTesting(
        CompositorView.Natives instance) {
