...
public class FeedReliabilityLoggingBridgeJni implements FeedReliabilityLoggingBridge.Natives {
  ...
  public static final JniStaticTestMocker<FeedReliabilityLoggingBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<FeedReliabilityLoggingBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        FeedReliabilityLoggingBridge.Natives instance) {
