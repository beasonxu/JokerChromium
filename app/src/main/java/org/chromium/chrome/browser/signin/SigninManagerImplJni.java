...
class SigninManagerImplJni implements SigninManagerImpl.Natives {
  ...
  public static final JniStaticTestMocker<SigninManagerImpl.Natives> TEST_HOOKS = new JniStaticTestMocker<SigninManagerImpl.Natives>() {
    @Override
    public void setInstanceForTesting(
        SigninManagerImpl.Natives instance) {
