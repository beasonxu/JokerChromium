...
class DistillablePageUtilsJni implements DistillablePageUtils.Natives {
  ...
  public static final JniStaticTestMocker<DistillablePageUtils.Natives> TEST_HOOKS = new JniStaticTestMocker<DistillablePageUtils.Natives>() {
    @Override
    public void setInstanceForTesting(
        DistillablePageUtils.Natives instance) {
