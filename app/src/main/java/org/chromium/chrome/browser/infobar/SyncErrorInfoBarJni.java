...
class SyncErrorInfoBarJni implements SyncErrorInfoBar.Natives {
  ...
  public static final JniStaticTestMocker<SyncErrorInfoBar.Natives> TEST_HOOKS = new JniStaticTestMocker<SyncErrorInfoBar.Natives>() {
    @Override
    public void setInstanceForTesting(
        SyncErrorInfoBar.Natives instance) {
