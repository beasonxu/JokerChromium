...
class ReparentingTaskJni implements ReparentingTask.Natives {
  private static ReparentingTask.Natives testInstance;

  public static final JniStaticTestMocker<ReparentingTask.Natives> TEST_HOOKS = new JniStaticTestMocker<ReparentingTask.Natives>() {
    @Override
    public void setInstanceForTesting(
        ReparentingTask.Natives instance) {
