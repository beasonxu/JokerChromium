...
class UsageStatsBridgeJni implements UsageStatsBridge.Natives {
  ...
  public static final JniStaticTestMocker<UsageStatsBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<UsageStatsBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        UsageStatsBridge.Natives instance) {
