...
public class AndroidSessionDurationsServiceStateJni implements AndroidSessionDurationsServiceState.Natives {
  ...
  public static final JniStaticTestMocker<AndroidSessionDurationsServiceState.Natives> TEST_HOOKS = new JniStaticTestMocker<AndroidSessionDurationsServiceState.Natives>() {
    @Override
    public void setInstanceForTesting(
        AndroidSessionDurationsServiceState.Natives instance) {
