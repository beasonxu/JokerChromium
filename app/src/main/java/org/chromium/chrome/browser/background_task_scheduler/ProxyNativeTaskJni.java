...
class ProxyNativeTaskJni implements ProxyNativeTask.Natives {
  ...
  public static final JniStaticTestMocker<ProxyNativeTask.Natives> TEST_HOOKS = new JniStaticTestMocker<ProxyNativeTask.Natives>() {
    @Override
    public void setInstanceForTesting(
        ProxyNativeTask.Natives instance) {
