...
class RlzPingHandlerJni implements RlzPingHandler.Natives {
  ...
  public static final JniStaticTestMocker<RlzPingHandler.Natives> TEST_HOOKS = new JniStaticTestMocker<RlzPingHandler.Natives>() {
    @Override
    public void setInstanceForTesting(
        RlzPingHandler.Natives instance) {
