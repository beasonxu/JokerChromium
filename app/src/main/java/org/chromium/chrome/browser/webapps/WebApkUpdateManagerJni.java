...
class WebApkUpdateManagerJni implements WebApkUpdateManager.Natives {
  ...
  public static final JniStaticTestMocker<WebApkUpdateManager.Natives> TEST_HOOKS = new JniStaticTestMocker<WebApkUpdateManager.Natives>() {
    @Override
    public void setInstanceForTesting(
        WebApkUpdateManager.Natives instance) {
  ...
  public void storeWebApkUpdateRequestToFile(String updateRequestPath, String startUrl,
      String scope, String name, String shortName, String primaryIconUrl, String primaryIconData,
