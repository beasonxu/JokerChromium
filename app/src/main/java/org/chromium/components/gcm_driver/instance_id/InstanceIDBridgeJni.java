...
class InstanceIDBridgeJni implements InstanceIDBridge.Natives {
  ...
  public static final JniStaticTestMocker<InstanceIDBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<InstanceIDBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        InstanceIDBridge.Natives instance) {
