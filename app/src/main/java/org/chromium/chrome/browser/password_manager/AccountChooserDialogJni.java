...
class AccountChooserDialogJni implements AccountChooserDialog.Natives {
  ...
  public static final JniStaticTestMocker<AccountChooserDialog.Natives> TEST_HOOKS = new JniStaticTestMocker<org.chromium.chrome.browser.password_manager.AccountChooserDialog.Natives>() {
    @Override
