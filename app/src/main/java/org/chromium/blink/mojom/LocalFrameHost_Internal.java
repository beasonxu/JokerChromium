...
class LocalFrameHost_Internal {
    ...
    private static final int DID_UPDATE_PREFERRED_COLOR_SCHEME_ORDINAL = 57;

    private static final int DID_INFER_COLOR_SCHEME_ORDINAL = 58;

    private static final int DID_CHANGE_SRC_DOC_ORDINAL = 59;

    private static final int RECEIVED_DELEGATED_CAPABILITY_ORDINAL = 60;
...
org.chromium.gfx.mojom.Size size) {
        ...
        @Override
        public void didUpdatePreferredColorScheme(
int preferredColorScheme) {
            ...
            getProxyHandler().getMessageReceiver().accept(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(DID_UPDATE_PREFERRED_COLOR_SCHEME_ORDINAL)));
...
int delegatedCapability) {
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case NAVIGATE_TO_NAVIGATION_API_KEY_ORDINAL: {
                        ...
                        getImpl().navigateToNavigationApiKey(data.key, data.hasUserGesture);
                        return true;
                    }
                    ...
                    case DID_CHANGE_IFRAME_ATTRIBUTES_ORDINAL: {
                        ...
                        getImpl().didChangeIframeAttributes(data.childFrameToken, data.parsedCspAttribute, data.anonymous);
                        return true;
                    }
                    ...
                    case DID_UPDATE_PREFERRED_COLOR_SCHEME_ORDINAL: {

                        LocalFrameHostDidUpdatePreferredColorSchemeParams data =
                                LocalFrameHostDidUpdatePreferredColorSchemeParams.deserialize(messageWithHeader.getPayload());

                        getImpl().didUpdatePreferredColorScheme(data.preferredColorScheme);
                        return true;
                    }
    ...
    static final class LocalFrameHostDidUpdatePreferredColorSchemeParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static LocalFrameHostDidUpdatePreferredColorSchemeParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
         ...
         * @throws org.chromium.mojo.bindings.DeserializationException on deserialization failure.
         */
        public static LocalFrameHostDidUpdatePreferredColorSchemeParams deserialize(java.nio.ByteBuffer data) {
            return deserialize(new org.chromium.mojo.bindings.Message(
                    data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
        }

        @SuppressWarnings("unchecked")
        public static LocalFrameHostDidUpdatePreferredColorSchemeParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            LocalFrameHostDidUpdatePreferredColorSchemeParams result;
            try {
                org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                final int elementsOrVersion = mainDataHeader.elementsOrVersion;
                result = new LocalFrameHostDidUpdatePreferredColorSchemeParams(elementsOrVersion);
                    {
                        
                    result.preferredColorScheme = decoder0.readInt(8);
