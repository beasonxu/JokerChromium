...
class ContextMenuNativeDelegateImplJni implements ContextMenuNativeDelegateImpl.Natives {
  ...
  public static final JniStaticTestMocker<ContextMenuNativeDelegateImpl.Natives> TEST_HOOKS = new JniStaticTestMocker<ContextMenuNativeDelegateImpl.Natives>() {
    @Override
    public void setInstanceForTesting(
        ContextMenuNativeDelegateImpl.Natives instance) {
