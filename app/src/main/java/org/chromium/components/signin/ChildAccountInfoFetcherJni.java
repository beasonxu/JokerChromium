...
class ChildAccountInfoFetcherJni implements ChildAccountInfoFetcher.Natives {
  ...
  public static final JniStaticTestMocker<ChildAccountInfoFetcher.Natives> TEST_HOOKS = new JniStaticTestMocker<ChildAccountInfoFetcher.Natives>() {
    @Override
    public void setInstanceForTesting(
        ChildAccountInfoFetcher.Natives instance) {
