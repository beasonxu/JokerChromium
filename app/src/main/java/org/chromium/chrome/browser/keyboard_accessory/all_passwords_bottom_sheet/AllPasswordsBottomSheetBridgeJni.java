...
class AllPasswordsBottomSheetBridgeJni implements AllPasswordsBottomSheetBridge.Natives {
  ...
  public static final JniStaticTestMocker<AllPasswordsBottomSheetBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<AllPasswordsBottomSheetBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        AllPasswordsBottomSheetBridge.Natives instance) {
