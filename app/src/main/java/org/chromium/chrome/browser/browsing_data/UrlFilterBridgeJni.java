...
class UrlFilterBridgeJni implements UrlFilterBridge.Natives {
  private static UrlFilterBridge.Natives testInstance;

  public static final JniStaticTestMocker<UrlFilterBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<UrlFilterBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        UrlFilterBridge.Natives instance) {
