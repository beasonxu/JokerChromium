...
class PasswordCheckBridgeJni implements PasswordCheckBridge.Natives {
  ...
  public static final JniStaticTestMocker<PasswordCheckBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<PasswordCheckBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        PasswordCheckBridge.Natives instance) {
