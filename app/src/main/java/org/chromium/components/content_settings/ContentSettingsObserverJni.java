...
class ContentSettingsObserverJni implements ContentSettingsObserver.Natives {
  ...
  public static final JniStaticTestMocker<ContentSettingsObserver.Natives> TEST_HOOKS = new JniStaticTestMocker<ContentSettingsObserver.Natives>() {
    @Override
    public void setInstanceForTesting(
        ContentSettingsObserver.Natives instance) {
