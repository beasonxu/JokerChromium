...
public class IdentityServicesProviderJni implements IdentityServicesProvider.Natives {
  ...
  public static final JniStaticTestMocker<IdentityServicesProvider.Natives> TEST_HOOKS = new JniStaticTestMocker<IdentityServicesProvider.Natives>() {
    @Override
    public void setInstanceForTesting(
        IdentityServicesProvider.Natives instance) {
