...
public class LegacyIncognitoDescriptionView
    ...
    private void adjustLayout() {
        ...
        if (mWidthDp <= WIDE_LAYOUT_THRESHOLD_DP) {
            ...
            mSubtitle.setLayoutParams(new LayoutParams(
                    contentWidthPx, LayoutParams.WRAP_CONTENT));
        ...
        for (TextView paragraph : mParagraphs) {
            ...
            ((LayoutParams) paragraph.getLayoutParams())
        ...
        LayoutParams params = (LayoutParams) mLearnMore.getLayoutParams();
    ...
    private void adjustCookieControlsCard() {
        if (mWidthDp <= WIDE_LAYOUT_THRESHOLD_DP) {
            // Portrait
            mCookieControlsCard.getLayoutParams().width = LayoutParams.MATCH_PARENT;
        } else {
            // Landscape
