...
class UsbMidiDeviceFactoryAndroidJni implements UsbMidiDeviceFactoryAndroid.Natives {
  ...
  public static final JniStaticTestMocker<UsbMidiDeviceFactoryAndroid.Natives> TEST_HOOKS = new JniStaticTestMocker<org.chromium.midi.UsbMidiDeviceFactoryAndroid.Natives>() {
    @Override
