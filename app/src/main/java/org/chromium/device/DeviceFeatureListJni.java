...
class DeviceFeatureListJni implements DeviceFeatureList.Natives {
  ...
  public static final JniStaticTestMocker<DeviceFeatureList.Natives> TEST_HOOKS = new JniStaticTestMocker<DeviceFeatureList.Natives>() {
    @Override
    public void setInstanceForTesting(DeviceFeatureList.Natives instance) {
