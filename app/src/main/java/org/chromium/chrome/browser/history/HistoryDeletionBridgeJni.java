...
class HistoryDeletionBridgeJni implements HistoryDeletionBridge.Natives {
  ...
  public static final JniStaticTestMocker<HistoryDeletionBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<HistoryDeletionBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        HistoryDeletionBridge.Natives instance) {
