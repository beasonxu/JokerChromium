...
class UsbMidiDeviceAndroidJni implements UsbMidiDeviceAndroid.Natives {
  ...
  public static final JniStaticTestMocker<UsbMidiDeviceAndroid.Natives> TEST_HOOKS = new JniStaticTestMocker<org.chromium.midi.UsbMidiDeviceAndroid.Natives>() {
    @Override
