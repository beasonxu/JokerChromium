...
class NetworkContext_Internal {
    ...
    private static final int SET_BLOCK_TRUST_TOKENS_ORDINAL = 9;

    private static final int CLEAR_NETWORKING_HISTORY_BETWEEN_ORDINAL = 10;

    private static final int CLEAR_HTTP_CACHE_ORDINAL = 11;

    private static final int COMPUTE_HTTP_CACHE_SIZE_ORDINAL = 12;

    private static final int NOTIFY_EXTERNAL_CACHE_HIT_ORDINAL = 13;

    private static final int CLEAR_HOST_CACHE_ORDINAL = 14;

    private static final int CLEAR_HTTP_AUTH_CACHE_ORDINAL = 15;

    private static final int CLEAR_REPORTING_CACHE_REPORTS_ORDINAL = 16;

    private static final int CLEAR_REPORTING_CACHE_CLIENTS_ORDINAL = 17;

    private static final int CLEAR_NETWORK_ERROR_LOGGING_ORDINAL = 18;

    private static final int CLEAR_DOMAIN_RELIABILITY_ORDINAL = 19;

    private static final int GET_DOMAIN_RELIABILITY_JSON_ORDINAL = 20;

    private static final int SET_DOCUMENT_REPORTING_ENDPOINTS_ORDINAL = 21;

    private static final int SEND_REPORTS_AND_REMOVE_SOURCE_ORDINAL = 22;

    private static final int QUEUE_REPORT_ORDINAL = 23;

    private static final int QUEUE_SIGNED_EXCHANGE_REPORT_ORDINAL = 24;

    private static final int CLOSE_ALL_CONNECTIONS_ORDINAL = 25;

    private static final int CLOSE_IDLE_CONNECTIONS_ORDINAL = 26;

    private static final int SET_NETWORK_CONDITIONS_ORDINAL = 27;

    private static final int SET_ACCEPT_LANGUAGE_ORDINAL = 28;

    private static final int SET_ENABLE_REFERRERS_ORDINAL = 29;

    private static final int SET_CT_POLICY_ORDINAL = 30;

    private static final int ADD_EXPECT_CT_ORDINAL = 31;

    private static final int SET_EXPECT_CT_TEST_REPORT_ORDINAL = 32;

    private static final int GET_EXPECT_CT_STATE_ORDINAL = 33;

    private static final int CREATE_UDP_SOCKET_ORDINAL = 34;

    private static final int CREATE_TCP_SERVER_SOCKET_ORDINAL = 35;

    private static final int CREATE_TCP_CONNECTED_SOCKET_ORDINAL = 36;

    private static final int CREATE_TCP_BOUND_SOCKET_ORDINAL = 37;

    private static final int CREATE_PROXY_RESOLVING_SOCKET_FACTORY_ORDINAL = 38;

    private static final int LOOK_UP_PROXY_FOR_URL_ORDINAL = 39;

    private static final int FORCE_RELOAD_PROXY_CONFIG_ORDINAL = 40;

    private static final int CLEAR_BAD_PROXIES_CACHE_ORDINAL = 41;

    private static final int CREATE_WEB_SOCKET_ORDINAL = 42;

    private static final int CREATE_WEB_TRANSPORT_ORDINAL = 43;

    private static final int CREATE_NET_LOG_EXPORTER_ORDINAL = 44;

    private static final int PRECONNECT_SOCKETS_ORDINAL = 45;

    private static final int CREATE_P2P_SOCKET_MANAGER_ORDINAL = 46;

    private static final int CREATE_MDNS_RESPONDER_ORDINAL = 47;

    private static final int RESOLVE_HOST_ORDINAL = 48;

    private static final int CREATE_HOST_RESOLVER_ORDINAL = 49;

    private static final int VERIFY_CERT_FOR_SIGNED_EXCHANGE_ORDINAL = 50;

    private static final int ADD_HSTS_ORDINAL = 51;

    private static final int IS_HSTS_ACTIVE_FOR_HOST_ORDINAL = 52;

    private static final int GET_HSTS_STATE_ORDINAL = 53;

    private static final int SET_CORS_ORIGIN_ACCESS_LISTS_FOR_ORIGIN_ORDINAL = 54;

    private static final int DELETE_DYNAMIC_DATA_FOR_HOST_ORDINAL = 55;

    private static final int SET_SPLIT_AUTH_CACHE_BY_NETWORK_ISOLATION_KEY_ORDINAL = 56;

    private static final int SAVE_HTTP_AUTH_CACHE_PROXY_ENTRIES_ORDINAL = 57;

    private static final int LOAD_HTTP_AUTH_CACHE_PROXY_ENTRIES_ORDINAL = 58;

    private static final int ADD_AUTH_CACHE_ENTRY_ORDINAL = 59;

    private static final int SET_CORS_NON_WILDCARD_REQUEST_HEADERS_SUPPORT_ORDINAL = 60;

    private static final int LOOKUP_SERVER_BASIC_AUTH_CREDENTIALS_ORDINAL = 61;

    private static final int ENABLE_STATIC_KEY_PINNING_FOR_TESTING_ORDINAL = 62;

    private static final int VERIFY_CERTIFICATE_FOR_TESTING_ORDINAL = 63;

    private static final int ADD_DOMAIN_RELIABILITY_CONTEXT_FOR_TESTING_ORDINAL = 64;

    private static final int FORCE_DOMAIN_RELIABILITY_UPLOADS_FOR_TESTING_ORDINAL = 65;

    private static final int GET_ORIGIN_POLICY_MANAGER_ORDINAL = 66;

    private static final int SET_SCT_AUDITING_MODE_ORDINAL = 67;

    private static final int ADD_REPORTING_API_OBSERVER_ORDINAL = 68;
...
GetDomainReliabilityJson_Response callback) {
...
ReportingApiObserver observer) {
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case QUEUE_REPORT_ORDINAL: {
                        ...
                        getImpl().queueReport(data.type, data.group, data.url, data.reportingSource, data.networkIsolationKey, data.userAgent, data.body);
                        return true;
                    }
                    ...
                    case CREATE_WEB_TRANSPORT_ORDINAL: {
                        ...
                        getImpl().createWebTransport(data.url, data.origin, data.networkIsolationKey, data.fingerprints, data.handshakeClient);
                        return true;
                    }
    ...
    static final class NetworkContextNotifyExternalCacheHitParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static NetworkContextNotifyExternalCacheHitParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                ...
                result = new NetworkContextNotifyExternalCacheHitParams(elementsOrVersion);
                    ...
                    result.includeCredentials = decoder0.readBoolean(32, 1);
                    }
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            encoder0.encode(this.includeCredentials, 32, 1);
        }
    }
    ...
    static class NetworkContextGetDomainReliabilityJsonResponseParamsForwardToCallback extends org.chromium.mojo.bindings.SideEffectFreeCloseable
            implements org.chromium.mojo.bindings.MessageReceiver {
        private final NetworkContext.GetDomainReliabilityJson_Response mCallback;

        NetworkContextGetDomainReliabilityJsonResponseParamsForwardToCallback(NetworkContext.GetDomainReliabilityJson_Response callback) {
            this.mCallback = callback;
        }
    ...
    static class NetworkContextGetDomainReliabilityJsonResponseParamsProxyToResponder implements NetworkContext.GetDomainReliabilityJson_Response {
    ...
    static final class NetworkContextQueueReportParams extends org.chromium.mojo.bindings.Struct {
        ...
        public static NetworkContextQueueReportParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                ...
                result = new NetworkContextQueueReportParams(elementsOrVersion);
                    ...
                    result.userAgent = decoder0.readString(48, true);
                    }
                    {
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            encoder0.encode(this.userAgent, 48, true);
    ...
    static class NetworkContextAddExpectCtResponseParamsForwardToCallback extends org.chromium.mojo.bindings.SideEffectFreeCloseable
            implements org.chromium.mojo.bindings.MessageReceiver {
        private final NetworkContext.AddExpectCt_Response mCallback;

        NetworkContextAddExpectCtResponseParamsForwardToCallback(NetworkContext.AddExpectCt_Response callback) {
            this.mCallback = callback;
        }
    ...
    static class NetworkContextAddExpectCtResponseParamsProxyToResponder implements NetworkContext.AddExpectCt_Response {
    ...
    static class NetworkContextSetExpectCtTestReportResponseParamsForwardToCallback extends org.chromium.mojo.bindings.SideEffectFreeCloseable
            implements org.chromium.mojo.bindings.MessageReceiver {
        private final NetworkContext.SetExpectCtTestReport_Response mCallback;

        NetworkContextSetExpectCtTestReportResponseParamsForwardToCallback(NetworkContext.SetExpectCtTestReport_Response callback) {
            this.mCallback = callback;
        }
    ...
    static class NetworkContextSetExpectCtTestReportResponseParamsProxyToResponder implements NetworkContext.SetExpectCtTestReport_Response {
    ...
    static final class NetworkContextGetExpectCtStateResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        private static final org.chromium.mojo.bindings.DataHeader[] VERSION_ARRAY = new org.chromium.mojo.bindings.DataHeader[] {new org.chromium.mojo.bindings.DataHeader(16, 0)};
        private static final org.chromium.mojo.bindings.DataHeader DEFAULT_STRUCT_INFO = VERSION_ARRAY[0];
        public org.chromium.mojo_base.mojom.DeprecatedDictionaryValue state;
        ...
        public static NetworkContextGetExpectCtStateResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                ...
                result = new NetworkContextGetExpectCtStateResponseParams(elementsOrVersion);
                    ...
                    org.chromium.mojo.bindings.Decoder decoder1 = decoder0.readPointer(8, false);
                    result.state = org.chromium.mojo_base.mojom.DeprecatedDictionaryValue.decode(decoder1);
                    }
    ...
    static class NetworkContextGetExpectCtStateResponseParamsForwardToCallback extends org.chromium.mojo.bindings.SideEffectFreeCloseable
            implements org.chromium.mojo.bindings.MessageReceiver {
        private final NetworkContext.GetExpectCtState_Response mCallback;

        NetworkContextGetExpectCtStateResponseParamsForwardToCallback(NetworkContext.GetExpectCtState_Response callback) {
            this.mCallback = callback;
        }
    ...
    static class NetworkContextGetExpectCtStateResponseParamsProxyToResponder implements NetworkContext.GetExpectCtState_Response {
        ...
        @Override
        public void call(org.chromium.mojo_base.mojom.DeprecatedDictionaryValue state) {
        ...
        public static NetworkContextCreateWebTransportParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                ...
                result = new NetworkContextCreateWebTransportParams(elementsOrVersion);
                    ...
                    result.handshakeClient = decoder0.readServiceInterface(40, false, WebTransportHandshakeClient.MANAGER);
                    }
