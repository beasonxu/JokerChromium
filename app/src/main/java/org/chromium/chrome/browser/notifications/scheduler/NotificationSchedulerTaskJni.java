...
class NotificationSchedulerTaskJni implements NotificationSchedulerTask.Natives {
  ...
  public static final JniStaticTestMocker<NotificationSchedulerTask.Natives> TEST_HOOKS = new JniStaticTestMocker<NotificationSchedulerTask.Natives>() {
    @Override
    public void setInstanceForTesting(
        NotificationSchedulerTask.Natives instance) {
