...
class AutocompleteResultJni implements AutocompleteResult.Natives {
  ...
  public static final JniStaticTestMocker<AutocompleteResult.Natives> TEST_HOOKS = new JniStaticTestMocker<AutocompleteResult.Natives>() {
    @Override
    public void setInstanceForTesting(
        AutocompleteResult.Natives instance) {
