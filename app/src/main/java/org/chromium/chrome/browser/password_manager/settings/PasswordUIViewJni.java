...
class PasswordUIViewJni implements PasswordUIView.Natives {
  ...
  public static final JniStaticTestMocker<PasswordUIView.Natives> TEST_HOOKS = new JniStaticTestMocker<PasswordUIView.Natives>() {
    @Override
    public void setInstanceForTesting(
        PasswordUIView.Natives instance) {
