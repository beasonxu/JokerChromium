...
public class PaintPreviewCompositorUtilsJni implements PaintPreviewCompositorUtils.Natives {
  ...
  public static final JniStaticTestMocker<PaintPreviewCompositorUtils.Natives> TEST_HOOKS = new JniStaticTestMocker<PaintPreviewCompositorUtils.Natives>() {
    @Override
    public void setInstanceForTesting(
        PaintPreviewCompositorUtils.Natives instance) {
