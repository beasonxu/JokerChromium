...
class HistoryClustersTabHelperJni implements HistoryClustersTabHelper.Natives {
  ...
  public static final JniStaticTestMocker<HistoryClustersTabHelper.Natives> TEST_HOOKS = new JniStaticTestMocker<HistoryClustersTabHelper.Natives>() {
    @Override
    public void setInstanceForTesting(
        HistoryClustersTabHelper.Natives instance) {
