...
class PartnerBookmarksReaderJni implements PartnerBookmarksReader.Natives {
  private static PartnerBookmarksReader.Natives testInstance;

  public static final JniStaticTestMocker<PartnerBookmarksReader.Natives> TEST_HOOKS = new JniStaticTestMocker<PartnerBookmarksReader.Natives>() {
    @Override
    public void setInstanceForTesting(
        PartnerBookmarksReader.Natives instance) {
