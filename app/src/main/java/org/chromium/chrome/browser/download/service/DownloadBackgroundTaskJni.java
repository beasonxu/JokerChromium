...
class DownloadBackgroundTaskJni implements DownloadBackgroundTask.Natives {
  ...
  public static final JniStaticTestMocker<DownloadBackgroundTask.Natives> TEST_HOOKS = new JniStaticTestMocker<DownloadBackgroundTask.Natives>() {
    @Override
    public void setInstanceForTesting(
        DownloadBackgroundTask.Natives instance) {
