...
class Fido2ApiJni implements Fido2Api.Natives {
  ...
  public static final JniStaticTestMocker<Fido2Api.Natives> TEST_HOOKS = new JniStaticTestMocker<Fido2Api.Natives>() {
    @Override
    public void setInstanceForTesting(Fido2Api.Natives instance) {
