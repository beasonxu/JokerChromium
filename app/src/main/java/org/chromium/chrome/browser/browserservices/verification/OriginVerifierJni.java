...
public class OriginVerifierJni implements OriginVerifier.Natives {
  ...
  public static final JniStaticTestMocker<OriginVerifier.Natives> TEST_HOOKS = new JniStaticTestMocker<OriginVerifier.Natives>() {
    @Override
    public void setInstanceForTesting(
        OriginVerifier.Natives instance) {
