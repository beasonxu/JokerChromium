...
class ChromeFeatureListJni implements ChromeFeatureList.Natives {
  ...
  public static final JniStaticTestMocker<ChromeFeatureList.Natives> TEST_HOOKS = new JniStaticTestMocker<ChromeFeatureList.Natives>() {
    @Override
    public void setInstanceForTesting(
        ChromeFeatureList.Natives instance) {
