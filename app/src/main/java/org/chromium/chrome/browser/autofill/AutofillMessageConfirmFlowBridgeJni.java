...
class AutofillMessageConfirmFlowBridgeJni implements AutofillMessageConfirmFlowBridge.Natives {
  ...
  public static final JniStaticTestMocker<AutofillMessageConfirmFlowBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<AutofillMessageConfirmFlowBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        AutofillMessageConfirmFlowBridge.Natives instance) {
