...
class RevenueStatsJni implements RevenueStats.Natives {
  private static RevenueStats.Natives testInstance;

  public static final JniStaticTestMocker<RevenueStats.Natives> TEST_HOOKS = new JniStaticTestMocker<RevenueStats.Natives>() {
    @Override
    public void setInstanceForTesting(RevenueStats.Natives instance) {
