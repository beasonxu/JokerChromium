...
class TabBrowserControlsConstraintsHelperJni implements TabBrowserControlsConstraintsHelper.Natives {
  private static TabBrowserControlsConstraintsHelper.Natives testInstance;

  public static final JniStaticTestMocker<TabBrowserControlsConstraintsHelper.Natives> TEST_HOOKS = new JniStaticTestMocker<TabBrowserControlsConstraintsHelper.Natives>() {
    @Override
    public void setInstanceForTesting(
        TabBrowserControlsConstraintsHelper.Natives instance) {
