...
public final class UrlRequest extends org.chromium.mojo.bindings.Struct {
    ...
    public static UrlRequest decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new UrlRequest(elementsOrVersion);
                ...
                result.originatedFromServiceWorker = decoder0.readBoolean(32, 1);
                }
                {
                    
                result.skipServiceWorker = decoder0.readBoolean(32, 2);
                }
                {
                    
                result.corbDetachable = decoder0.readBoolean(32, 3);
                }
                {
                ...
                result.hasUserGesture = decoder0.readBoolean(32, 5);
                }
                {
                    
                result.enableLoadTiming = decoder0.readBoolean(32, 6);
                }
                {
                    
                result.enableUploadProgress = decoder0.readBoolean(32, 7);
                }
                {
                    
                result.doNotPromptForLogin = decoder0.readBoolean(33, 0);
                }
                {
                    
                result.isOutermostMainFrame = decoder0.readBoolean(33, 1);
                }
                {
                    
                result.upgradeIfInsecure = decoder0.readBoolean(33, 2);
                }
                {
                    
                result.isRevalidating = decoder0.readBoolean(33, 3);
                }
                {
                    
                result.isSignedExchangePrefetchCacheEnabled = decoder0.readBoolean(33, 4);
                }
                {
                    
                result.isFetchLikeApi = decoder0.readBoolean(33, 5);
                }
                {
                    
                result.isFavicon = decoder0.readBoolean(33, 6);
                }
                {
                    
                result.obeyOriginPolicy = decoder0.readBoolean(33, 7);
                }
                {
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        encoder0.encode(this.originatedFromServiceWorker, 32, 1);
        
        encoder0.encode(this.skipServiceWorker, 32, 2);
        
        encoder0.encode(this.corbDetachable, 32, 3);
        
        encoder0.encode(this.keepalive, 32, 4);
        
        encoder0.encode(this.hasUserGesture, 32, 5);
        
        encoder0.encode(this.enableLoadTiming, 32, 6);
        
        encoder0.encode(this.enableUploadProgress, 32, 7);
        
        encoder0.encode(this.doNotPromptForLogin, 33, 0);
        
        encoder0.encode(this.isOutermostMainFrame, 33, 1);
        
        encoder0.encode(this.upgradeIfInsecure, 33, 2);
        
        encoder0.encode(this.isRevalidating, 33, 3);
        
        encoder0.encode(this.isSignedExchangePrefetchCacheEnabled, 33, 4);
        
        encoder0.encode(this.isFetchLikeApi, 33, 5);
        
        encoder0.encode(this.isFavicon, 33, 6);
        
        encoder0.encode(this.obeyOriginPolicy, 33, 7);
