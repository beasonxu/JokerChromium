...
class DownloadManagerBridgeJni implements DownloadManagerBridge.Natives {
  ...
  public static final JniStaticTestMocker<DownloadManagerBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<DownloadManagerBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        DownloadManagerBridge.Natives instance) {
