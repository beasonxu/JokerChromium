...
public final class UrlLoaderCompletionStatus extends org.chromium.mojo.bindings.Struct {
    ...
    private UrlLoaderCompletionStatus(int version) {
        ...
        this.pervasivePayloadRequested = (boolean) false;
    }
    ...
    public static UrlLoaderCompletionStatus decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new UrlLoaderCompletionStatus(elementsOrVersion);
                ...
                result.shouldReportCorbBlocking = decoder0.readBoolean(16, 1);
                }
                {
                    
                result.shouldCollapseInitiator = decoder0.readBoolean(16, 2);
                }
                {
                    
                result.pervasivePayloadRequested = decoder0.readBoolean(16, 3);
                }
                {
                    
                result.trustTokenOperationStatus = decoder0.readInt(20);
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        encoder0.encode(this.shouldReportCorbBlocking, 16, 1);
        
        encoder0.encode(this.shouldCollapseInitiator, 16, 2);
        
        encoder0.encode(this.pervasivePayloadRequested, 16, 3);
        
        encoder0.encode(this.trustTokenOperationStatus, 20);
        ...
        encoder0.encode(this.sslInfo, 64, true);
        
        encoder0.encode(this.blockedByResponseReason, 72, true);
        
        encoder0.encode(this.proxyServer, 80, false);
        
        encoder0.encode(this.resolveErrorInfo, 88, false);
    }
}