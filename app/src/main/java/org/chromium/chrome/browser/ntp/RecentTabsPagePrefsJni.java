...
class RecentTabsPagePrefsJni implements RecentTabsPagePrefs.Natives {
  ...
  public static final JniStaticTestMocker<RecentTabsPagePrefs.Natives> TEST_HOOKS = new JniStaticTestMocker<RecentTabsPagePrefs.Natives>() {
    @Override
    public void setInstanceForTesting(
        RecentTabsPagePrefs.Natives instance) {
