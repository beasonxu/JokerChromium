...
class PasswordGenerationDialogBridgeJni implements PasswordGenerationDialogBridge.Natives {
  ...
  public static final JniStaticTestMocker<PasswordGenerationDialogBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<PasswordGenerationDialogBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        PasswordGenerationDialogBridge.Natives instance) {
