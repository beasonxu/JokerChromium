...
class TrackerFactoryJni implements TrackerFactory.Natives {
  ...
  public static final JniStaticTestMocker<TrackerFactory.Natives> TEST_HOOKS = new JniStaticTestMocker<TrackerFactory.Natives>() {
    @Override
    public void setInstanceForTesting(
        TrackerFactory.Natives instance) {
