...
class CronetUrlRequestContextJni implements CronetUrlRequestContext.Natives {
  ...
  public static final JniStaticTestMocker<CronetUrlRequestContext.Natives> TEST_HOOKS = new JniStaticTestMocker<CronetUrlRequestContext.Natives>() {
    @Override
    public void setInstanceForTesting(
        CronetUrlRequestContext.Natives instance) {
