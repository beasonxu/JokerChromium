...
public final class RequestIdTokenStatus {
    ...
    @IntDef({
        ...
        RequestIdTokenStatus.SUCCESS,
        RequestIdTokenStatus.APPROVAL_DECLINED,
        RequestIdTokenStatus.ERROR_TOO_MANY_REQUESTS,
        RequestIdTokenStatus.ERROR_CANCELED,
        RequestIdTokenStatus.ERROR})
