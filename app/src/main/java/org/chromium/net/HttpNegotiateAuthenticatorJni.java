...
class HttpNegotiateAuthenticatorJni implements HttpNegotiateAuthenticator.Natives {
  ...
  public static final JniStaticTestMocker<HttpNegotiateAuthenticator.Natives> TEST_HOOKS = new JniStaticTestMocker<org.chromium.net.HttpNegotiateAuthenticator.Natives>() {
    @Override
