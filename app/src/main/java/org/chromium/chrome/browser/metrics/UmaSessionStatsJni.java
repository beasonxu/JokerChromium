...
class UmaSessionStatsJni implements UmaSessionStats.Natives {
  ...
  public static final JniStaticTestMocker<UmaSessionStats.Natives> TEST_HOOKS = new JniStaticTestMocker<UmaSessionStats.Natives>() {
    @Override
    public void setInstanceForTesting(
        UmaSessionStats.Natives instance) {
