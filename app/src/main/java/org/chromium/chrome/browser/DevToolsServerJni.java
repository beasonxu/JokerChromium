...
class DevToolsServerJni implements DevToolsServer.Natives {
  ...
  public static final JniStaticTestMocker<DevToolsServer.Natives> TEST_HOOKS = new JniStaticTestMocker<DevToolsServer.Natives>() {
    @Override
    public void setInstanceForTesting(DevToolsServer.Natives instance) {
