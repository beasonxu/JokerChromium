...
class VideoTutorialServiceBridgeJni implements VideoTutorialServiceBridge.Natives {
  ...
  public static final JniStaticTestMocker<VideoTutorialServiceBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<VideoTutorialServiceBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        VideoTutorialServiceBridge.Natives instance) {
