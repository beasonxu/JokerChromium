...
class CachedFeatureFlagsJni implements CachedFeatureFlags.Natives {
  ...
  public static final JniStaticTestMocker<CachedFeatureFlags.Natives> TEST_HOOKS = new JniStaticTestMocker<CachedFeatureFlags.Natives>() {
    @Override
    public void setInstanceForTesting(
        CachedFeatureFlags.Natives instance) {
