...
class DownloadStartupUtilsJni implements DownloadStartupUtils.Natives {
  private static DownloadStartupUtils.Natives testInstance;

  public static final JniStaticTestMocker<DownloadStartupUtils.Natives> TEST_HOOKS = new JniStaticTestMocker<DownloadStartupUtils.Natives>() {
    @Override
    public void setInstanceForTesting(
        DownloadStartupUtils.Natives instance) {
