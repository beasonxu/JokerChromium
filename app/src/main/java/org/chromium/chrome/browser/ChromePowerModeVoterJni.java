...
class ChromePowerModeVoterJni implements ChromePowerModeVoter.Natives {
  ...
  public static final JniStaticTestMocker<ChromePowerModeVoter.Natives> TEST_HOOKS = new JniStaticTestMocker<ChromePowerModeVoter.Natives>() {
    @Override
    public void setInstanceForTesting(
        ChromePowerModeVoter.Natives instance) {
