...
class EnterpriseInfoJni implements EnterpriseInfo.Natives {
  ...
  public static final JniStaticTestMocker<EnterpriseInfo.Natives> TEST_HOOKS = new JniStaticTestMocker<EnterpriseInfo.Natives>() {
    @Override
    public void setInstanceForTesting(
        EnterpriseInfo.Natives instance) {
