 ...
 */
public abstract class DateDividedAdapter extends Adapter<ViewHolder> {
    static {
    ...
    /**
     * A {@link ViewHolder} that displays a date header.
     */
    ...
    protected static class BasicViewHolder extends ViewHolder {
        public BasicViewHolder(View itemView) {
            super(itemView);
        }
    }

    protected static class SubsectionHeaderViewHolder extends ViewHolder {
        private View mView;
