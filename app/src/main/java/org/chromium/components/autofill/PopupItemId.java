...
@IntDef({
    ...
    PopupItemId.ITEM_ID_PASSWORD_ACCOUNT_STORAGE_OPT_IN, PopupItemId.ITEM_ID_USE_VIRTUAL_CARD,
    ...
    PopupItemId.ITEM_ID_VIRTUAL_CREDIT_CARD_ENTRY, PopupItemId.ITEM_ID_WEBAUTHN_CREDENTIAL,
    PopupItemId.ITEM_ID_MERCHANT_PROMO_CODE_ENTRY, PopupItemId.ITEM_ID_SEE_PROMO_CODE_DETAILS
})
...
public @interface PopupItemId {
  ...
  int ITEM_ID_WEBAUTHN_CREDENTIAL = -28;
  int ITEM_ID_MERCHANT_PROMO_CODE_ENTRY = -29;
  int ITEM_ID_SEE_PROMO_CODE_DETAILS = -30;
}
