...
class NetworkActiveNotifierJni implements NetworkActiveNotifier.Natives {
  ...
  public static final JniStaticTestMocker<NetworkActiveNotifier.Natives> TEST_HOOKS = new JniStaticTestMocker<org.chromium.net.NetworkActiveNotifier.Natives>() {
    @Override
