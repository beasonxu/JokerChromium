...
class AutofillPopupBridgeJni implements AutofillPopupBridge.Natives {
  ...
  public static final JniStaticTestMocker<AutofillPopupBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<AutofillPopupBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        AutofillPopupBridge.Natives instance) {
