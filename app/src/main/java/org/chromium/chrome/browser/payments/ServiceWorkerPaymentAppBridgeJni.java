...
class ServiceWorkerPaymentAppBridgeJni implements ServiceWorkerPaymentAppBridge.Natives {
  private static ServiceWorkerPaymentAppBridge.Natives testInstance;

  public static final JniStaticTestMocker<ServiceWorkerPaymentAppBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<ServiceWorkerPaymentAppBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        ServiceWorkerPaymentAppBridge.Natives instance) {
