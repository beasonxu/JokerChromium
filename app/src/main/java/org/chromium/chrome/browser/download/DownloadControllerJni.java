...
class DownloadControllerJni implements DownloadController.Natives {
  ...
  public static final JniStaticTestMocker<DownloadController.Natives> TEST_HOOKS = new JniStaticTestMocker<DownloadController.Natives>() {
    @Override
    public void setInstanceForTesting(
        DownloadController.Natives instance) {
