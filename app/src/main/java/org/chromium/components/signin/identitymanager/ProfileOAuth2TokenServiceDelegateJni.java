...
class ProfileOAuth2TokenServiceDelegateJni implements ProfileOAuth2TokenServiceDelegate.Natives {
  ...
  public static final JniStaticTestMocker<ProfileOAuth2TokenServiceDelegate.Natives> TEST_HOOKS = new JniStaticTestMocker<ProfileOAuth2TokenServiceDelegate.Natives>() {
    @Override
    public void setInstanceForTesting(
        ProfileOAuth2TokenServiceDelegate.Natives instance) {
