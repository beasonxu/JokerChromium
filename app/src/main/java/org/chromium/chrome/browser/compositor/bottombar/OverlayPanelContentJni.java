...
class OverlayPanelContentJni implements OverlayPanelContent.Natives {
  ...
  public static final JniStaticTestMocker<OverlayPanelContent.Natives> TEST_HOOKS = new JniStaticTestMocker<OverlayPanelContent.Natives>() {
    @Override
    public void setInstanceForTesting(
        OverlayPanelContent.Natives instance) {
