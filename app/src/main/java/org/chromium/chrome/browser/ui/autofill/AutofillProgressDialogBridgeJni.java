...
class AutofillProgressDialogBridgeJni implements AutofillProgressDialogBridge.Natives {
  ...
  public static final JniStaticTestMocker<AutofillProgressDialogBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<AutofillProgressDialogBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        AutofillProgressDialogBridge.Natives instance) {
