...
class PrefServiceJni implements PrefService.Natives {
  ...
  public static final JniStaticTestMocker<PrefService.Natives> TEST_HOOKS = new JniStaticTestMocker<PrefService.Natives>() {
    @Override
    public void setInstanceForTesting(PrefService.Natives instance) {
