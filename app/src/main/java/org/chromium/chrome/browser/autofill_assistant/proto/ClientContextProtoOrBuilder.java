...
public interface ClientContextProtoOrBuilder extends
   ...
   */
  org.chromium.chrome.browser.autofill_assistant.proto.TriggerScriptProto.TriggerUIType getTriggerUiType();
   ...
   */
  org.chromium.chrome.browser.autofill_assistant.proto.ClientContextProto.WindowSize getWindowSize();
   ...
   */
  org.chromium.chrome.browser.autofill_assistant.proto.ClientContextProto.ScreenOrientation getScreenOrientation();
   ...
   */
  org.chromium.chrome.browser.autofill_assistant.proto.ClientContextProto.PlatformType getPlatformType();

  /**
   * <code>optional .autofill_assistant.ClientContextProto.AnnotateDomModelContextProto annotate_dom_model_context = 22;</code>
   * @return Whether the annotateDomModelContext field is set.
   */
  boolean hasAnnotateDomModelContext();
  /**
   * <code>optional .autofill_assistant.ClientContextProto.AnnotateDomModelContextProto annotate_dom_model_context = 22;</code>
   * @return The annotateDomModelContext.
   */
  org.chromium.chrome.browser.autofill_assistant.proto.ClientContextProto.AnnotateDomModelContextProto getAnnotateDomModelContext();
   ...
   */
  boolean hasJsFlowLibraryLoaded();
  /**
   * <pre>
   * Set if the client has the JS flow library needed for JS flow execution.
   * </pre>
   ...
   */
  boolean getJsFlowLibraryLoaded();
