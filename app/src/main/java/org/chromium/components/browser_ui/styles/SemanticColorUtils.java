...
public class SemanticColorUtils {
    ...
    public static @ColorInt int getDefaultTextColorSecondary(Context context) {
        return resolve(R.attr.colorOnPrimary, R.color.default_text_color_secondary_baseline,
                context);
    }
    ...
    public static @ColorInt int getDefaultIconColorInverse(Context context) {
        return resolve(
                R.attr.colorOnPrimary, R.color.default_icon_color_inverse_baseline, context);
    }
    ...
    public static @ColorInt int getDefaultIconColorSecondary(Context context) {
        return resolve(R.attr.colorOnPrimary, R.color.default_icon_color_secondary_baseline,
                context);
    }
    ...
    public static @ColorInt int getDividerLineBgColor(Context context) {
        return resolve(R.attr.colorOnPrimary, R.color.divider_line_bg_color_baseline, context);
    }
