...
class CredentialLeakDialogBridgeJni implements CredentialLeakDialogBridge.Natives {
  ...
  public static final JniStaticTestMocker<CredentialLeakDialogBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<CredentialLeakDialogBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        CredentialLeakDialogBridge.Natives instance) {
