...
class DownloadManagerServiceJni implements DownloadManagerService.Natives {
  ...
  public static final JniStaticTestMocker<DownloadManagerService.Natives> TEST_HOOKS = new JniStaticTestMocker<DownloadManagerService.Natives>() {
    @Override
    public void setInstanceForTesting(
        DownloadManagerService.Natives instance) {
