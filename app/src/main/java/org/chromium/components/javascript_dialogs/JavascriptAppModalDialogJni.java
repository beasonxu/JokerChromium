...
class JavascriptAppModalDialogJni implements JavascriptAppModalDialog.Natives {
  ...
  public static final JniStaticTestMocker<JavascriptAppModalDialog.Natives> TEST_HOOKS = new JniStaticTestMocker<JavascriptAppModalDialog.Natives>() {
    @Override
    public void setInstanceForTesting(
        JavascriptAppModalDialog.Natives instance) {
