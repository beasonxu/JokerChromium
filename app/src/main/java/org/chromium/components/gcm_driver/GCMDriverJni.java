...
class GCMDriverJni implements GCMDriver.Natives {
  private static GCMDriver.Natives testInstance;

  public static final JniStaticTestMocker<GCMDriver.Natives> TEST_HOOKS = new JniStaticTestMocker<GCMDriver.Natives>() {
    @Override
    public void setInstanceForTesting(GCMDriver.Natives instance) {
