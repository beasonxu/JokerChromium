...
class PrefetchBackgroundTaskJni implements PrefetchBackgroundTask.Natives {
  ...
  public static final JniStaticTestMocker<PrefetchBackgroundTask.Natives> TEST_HOOKS = new JniStaticTestMocker<PrefetchBackgroundTask.Natives>() {
    @Override
    public void setInstanceForTesting(
        PrefetchBackgroundTask.Natives instance) {
