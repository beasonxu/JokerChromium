...
class DomDistillerTabUtilsJni implements DomDistillerTabUtils.Natives {
  ...
  public static final JniStaticTestMocker<DomDistillerTabUtils.Natives> TEST_HOOKS = new JniStaticTestMocker<DomDistillerTabUtils.Natives>() {
    @Override
    public void setInstanceForTesting(
        DomDistillerTabUtils.Natives instance) {
