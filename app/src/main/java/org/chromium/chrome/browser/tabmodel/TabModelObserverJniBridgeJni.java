...
class TabModelObserverJniBridgeJni implements TabModelObserverJniBridge.Natives {
  ...
  public static final JniStaticTestMocker<TabModelObserverJniBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<TabModelObserverJniBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        TabModelObserverJniBridge.Natives instance) {
