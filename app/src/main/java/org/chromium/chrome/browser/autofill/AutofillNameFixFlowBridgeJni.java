...
class AutofillNameFixFlowBridgeJni implements AutofillNameFixFlowBridge.Natives {
  ...
  public static final JniStaticTestMocker<AutofillNameFixFlowBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<AutofillNameFixFlowBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        AutofillNameFixFlowBridge.Natives instance) {
