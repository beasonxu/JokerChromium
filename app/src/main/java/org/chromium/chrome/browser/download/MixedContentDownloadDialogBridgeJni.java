...
class MixedContentDownloadDialogBridgeJni implements MixedContentDownloadDialogBridge.Natives {
  ...
  public static final JniStaticTestMocker<MixedContentDownloadDialogBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<MixedContentDownloadDialogBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        MixedContentDownloadDialogBridge.Natives instance) {
