...
class AutoSigninFirstRunDialogJni implements AutoSigninFirstRunDialog.Natives {
  private static AutoSigninFirstRunDialog.Natives testInstance;

  public static final JniStaticTestMocker<AutoSigninFirstRunDialog.Natives> TEST_HOOKS = new JniStaticTestMocker<AutoSigninFirstRunDialog.Natives>() {
    @Override
    public void setInstanceForTesting(
        AutoSigninFirstRunDialog.Natives instance) {
