...
public class TabModelJniBridgeJni implements TabModelJniBridge.Natives {
  ...
  public static final JniStaticTestMocker<TabModelJniBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<TabModelJniBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        TabModelJniBridge.Natives instance) {
