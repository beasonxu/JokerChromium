...
class IdentityMutatorJni implements IdentityMutator.Natives {
  ...
  public static final JniStaticTestMocker<IdentityMutator.Natives> TEST_HOOKS = new JniStaticTestMocker<IdentityMutator.Natives>() {
    @Override
    public void setInstanceForTesting(
        IdentityMutator.Natives instance) {
