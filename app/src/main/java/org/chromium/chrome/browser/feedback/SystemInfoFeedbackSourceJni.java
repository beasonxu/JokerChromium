...
class SystemInfoFeedbackSourceJni implements SystemInfoFeedbackSource.Natives {
  ...
  public static final JniStaticTestMocker<SystemInfoFeedbackSource.Natives> TEST_HOOKS = new JniStaticTestMocker<SystemInfoFeedbackSource.Natives>() {
    @Override
    public void setInstanceForTesting(
        SystemInfoFeedbackSource.Natives instance) {
