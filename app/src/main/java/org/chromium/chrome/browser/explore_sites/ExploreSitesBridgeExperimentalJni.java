...
class ExploreSitesBridgeExperimentalJni implements ExploreSitesBridgeExperimental.Natives {
  ...
  public static final JniStaticTestMocker<ExploreSitesBridgeExperimental.Natives> TEST_HOOKS = new JniStaticTestMocker<ExploreSitesBridgeExperimental.Natives>() {
    @Override
    public void setInstanceForTesting(
        ExploreSitesBridgeExperimental.Natives instance) {
