...
class WebContextFetcherJni implements WebContextFetcher.Natives {
  ...
  public static final JniStaticTestMocker<WebContextFetcher.Natives> TEST_HOOKS = new JniStaticTestMocker<WebContextFetcher.Natives>() {
    @Override
    public void setInstanceForTesting(
        WebContextFetcher.Natives instance) {
