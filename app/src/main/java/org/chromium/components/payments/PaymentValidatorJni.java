...
class PaymentValidatorJni implements PaymentValidator.Natives {
  ...
  public static final JniStaticTestMocker<PaymentValidator.Natives> TEST_HOOKS = new JniStaticTestMocker<PaymentValidator.Natives>() {
    @Override
    public void setInstanceForTesting(
        PaymentValidator.Natives instance) {
