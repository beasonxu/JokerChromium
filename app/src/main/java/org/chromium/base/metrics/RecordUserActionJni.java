...
class RecordUserActionJni implements RecordUserAction.Natives {
  ...
  public static final JniStaticTestMocker<RecordUserAction.Natives> TEST_HOOKS = new JniStaticTestMocker<RecordUserAction.Natives>() {
    @Override
    public void setInstanceForTesting(RecordUserAction.Natives instance) {
