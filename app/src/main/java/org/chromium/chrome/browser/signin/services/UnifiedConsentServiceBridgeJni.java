...
class UnifiedConsentServiceBridgeJni implements UnifiedConsentServiceBridge.Natives {
  ...
  public static final JniStaticTestMocker<UnifiedConsentServiceBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<UnifiedConsentServiceBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        UnifiedConsentServiceBridge.Natives instance) {
