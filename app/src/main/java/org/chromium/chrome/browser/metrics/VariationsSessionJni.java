...
class VariationsSessionJni implements VariationsSession.Natives {
  ...
  public static final JniStaticTestMocker<VariationsSession.Natives> TEST_HOOKS = new JniStaticTestMocker<VariationsSession.Natives>() {
    @Override
    public void setInstanceForTesting(
        VariationsSession.Natives instance) {
