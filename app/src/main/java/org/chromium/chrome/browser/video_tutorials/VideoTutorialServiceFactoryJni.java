...
class VideoTutorialServiceFactoryJni implements VideoTutorialServiceFactory.Natives {
  ...
  public static final JniStaticTestMocker<VideoTutorialServiceFactory.Natives> TEST_HOOKS = new JniStaticTestMocker<VideoTutorialServiceFactory.Natives>() {
    @Override
    public void setInstanceForTesting(
        VideoTutorialServiceFactory.Natives instance) {
