...
public final class Manifest_ extends org.chromium.mojo.bindings.Struct {
    ...
    private static final int STRUCT_SIZE = 224;
    private static final org.chromium.mojo.bindings.DataHeader[] VERSION_ARRAY = new org.chromium.mojo.bindings.DataHeader[] {new org.chromium.mojo.bindings.DataHeader(224, 0)};
    ...
    public static Manifest_ decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new Manifest_(elementsOrVersion);
                ...
                result.handleLinks = decoder0.readInt(208);
                    HandleLinks.validate(result.handleLinks);
                    result.handleLinks = HandleLinks.toKnownValue(result.handleLinks);
                }
                {
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        encoder0.encode(this.handleLinks, 208);
        
        encoder0.encode(this.tabStrip, 216, true);
    }
}