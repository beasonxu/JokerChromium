...
class PasswordSyncControllerDelegateBridgeImplJni implements PasswordSyncControllerDelegateBridgeImpl.Natives {
  ...
  public static final JniStaticTestMocker<PasswordSyncControllerDelegateBridgeImpl.Natives> TEST_HOOKS = new org.chromium.base.JniStaticTestMocker<org.chromium.chrome.browser.password_manager.PasswordSyncControllerDelegateBridgeImpl.Natives>() {
    @java.lang.Override
    public void setInstanceForTesting(
        org.chromium.chrome.browser.password_manager.PasswordSyncControllerDelegateBridgeImpl.Natives instance) {
