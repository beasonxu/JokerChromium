...
class CustomTabsConnectionJni implements CustomTabsConnection.Natives {
  ...
  public static final JniStaticTestMocker<CustomTabsConnection.Natives> TEST_HOOKS = new JniStaticTestMocker<CustomTabsConnection.Natives>() {
    @Override
    public void setInstanceForTesting(
        CustomTabsConnection.Natives instance) {
