...
class PermissionsAndroidFeatureListJni implements PermissionsAndroidFeatureList.Natives {
  ...
  public static final JniStaticTestMocker<PermissionsAndroidFeatureList.Natives> TEST_HOOKS = new JniStaticTestMocker<PermissionsAndroidFeatureList.Natives>() {
    @Override
    public void setInstanceForTesting(
        PermissionsAndroidFeatureList.Natives instance) {
