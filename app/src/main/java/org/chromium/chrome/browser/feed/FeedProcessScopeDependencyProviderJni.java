...
public class FeedProcessScopeDependencyProviderJni implements FeedProcessScopeDependencyProvider.Natives {
  ...
  public static final JniStaticTestMocker<FeedProcessScopeDependencyProvider.Natives> TEST_HOOKS = new JniStaticTestMocker<FeedProcessScopeDependencyProvider.Natives>() {
    @Override
    public void setInstanceForTesting(
        FeedProcessScopeDependencyProvider.Natives instance) {
