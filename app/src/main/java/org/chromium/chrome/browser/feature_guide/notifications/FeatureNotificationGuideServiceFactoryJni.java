...
class FeatureNotificationGuideServiceFactoryJni implements FeatureNotificationGuideServiceFactory.Natives {
  ...
  public static final JniStaticTestMocker<FeatureNotificationGuideServiceFactory.Natives> TEST_HOOKS = new JniStaticTestMocker<FeatureNotificationGuideServiceFactory.Natives>() {
    @Override
    public void setInstanceForTesting(
        FeatureNotificationGuideServiceFactory.Natives instance) {
