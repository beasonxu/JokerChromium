...
class AutofillProfileBridgeJni implements AutofillProfileBridge.Natives {
  ...
  public static final JniStaticTestMocker<AutofillProfileBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<AutofillProfileBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        AutofillProfileBridge.Natives instance) {
