...
public class ServiceTabLauncherJni implements ServiceTabLauncher.Natives {
  private static ServiceTabLauncher.Natives testInstance;

  public static final JniStaticTestMocker<ServiceTabLauncher.Natives> TEST_HOOKS = new JniStaticTestMocker<ServiceTabLauncher.Natives>() {
    @Override
    public void setInstanceForTesting(
        ServiceTabLauncher.Natives instance) {
