...
class InfoBarContainerJni implements InfoBarContainer.Natives {
  ...
  public static final JniStaticTestMocker<InfoBarContainer.Natives> TEST_HOOKS = new JniStaticTestMocker<InfoBarContainer.Natives>() {
    @Override
    public void setInstanceForTesting(
        InfoBarContainer.Natives instance) {
