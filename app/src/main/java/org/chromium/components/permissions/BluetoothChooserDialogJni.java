...
public class BluetoothChooserDialogJni implements BluetoothChooserDialog.Natives {
  ...
  public static final JniStaticTestMocker<BluetoothChooserDialog.Natives> TEST_HOOKS = new JniStaticTestMocker<BluetoothChooserDialog.Natives>() {
    @Override
    public void setInstanceForTesting(
        BluetoothChooserDialog.Natives instance) {
