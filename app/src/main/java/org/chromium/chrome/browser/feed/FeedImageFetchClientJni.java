...
class FeedImageFetchClientJni implements FeedImageFetchClient.Natives {
  ...
  public static final JniStaticTestMocker<FeedImageFetchClient.Natives> TEST_HOOKS = new JniStaticTestMocker<FeedImageFetchClient.Natives>() {
    @Override
    public void setInstanceForTesting(
        FeedImageFetchClient.Natives instance) {
