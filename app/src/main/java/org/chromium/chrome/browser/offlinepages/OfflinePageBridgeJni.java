...
class OfflinePageBridgeJni implements OfflinePageBridge.Natives {
  ...
  public static final JniStaticTestMocker<OfflinePageBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<OfflinePageBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        OfflinePageBridge.Natives instance) {
