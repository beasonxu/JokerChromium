...
class AboutSettingsBridgeJni implements AboutSettingsBridge.Natives {
  private static AboutSettingsBridge.Natives testInstance;

  public static final JniStaticTestMocker<AboutSettingsBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<AboutSettingsBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        AboutSettingsBridge.Natives instance) {
