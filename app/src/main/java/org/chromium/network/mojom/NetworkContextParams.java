...
public final class NetworkContextParams extends org.chromium.mojo.bindings.Struct {
    ...
    public static NetworkContextParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new NetworkContextParams(elementsOrVersion);
                ...
                result.sctAuditingMode = decoder0.readInt(132);
                ...
                result.cookieManager = decoder0.readInterfaceRequest(160, true);
                }
                {
                    
                result.firstPartySetsAccessDelegateReceiver = decoder0.readInterfaceRequest(164, true);
                }
                {
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        encoder0.encode(this.sctAuditingMode, 132);
        
        encoder0.encode(this.ctPolicy, 136, true);
        
        encoder0.encode(this.certVerifierParams, 144, false);
        
        encoder0.encode(this.cookieManagerParams, 152, true);
        
        encoder0.encode(this.cookieManager, 160, true);
        
        encoder0.encode(this.firstPartySetsAccessDelegateReceiver, 164, true);
        ...
        encoder0.encode(this.httpAuthStaticNetworkContextParams, 208, true);
        
        encoder0.encode(this.filePaths, 216, true);
        
        encoder0.encode(this.firstPartySetsAccessDelegateParams, 224, true);
    }
}