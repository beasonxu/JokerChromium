...
class HistoryReportJniBridgeJni implements HistoryReportJniBridge.Natives {
  ...
  public static final JniStaticTestMocker<HistoryReportJniBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<HistoryReportJniBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        HistoryReportJniBridge.Natives instance) {
