...
public final class MostVisitedTilesProperties {
    ...
    public static final PropertyModel.WritableBooleanPropertyKey IS_PLACEHOLDER_VISIBLE =
            new PropertyModel.WritableBooleanPropertyKey();
    public static final WritableObjectPropertyKey<View> PLACEHOLDER_VIEW =
    ...
    // skipping the check.
    public static final WritableObjectPropertyKey<Integer> HORIZONTAL_INTERVAL_PADDINGS =
            new WritableObjectPropertyKey<>(true);
    public static final WritableObjectPropertyKey<Integer> HORIZONTAL_EDGE_PADDINGS =
            new WritableObjectPropertyKey<>(true);
