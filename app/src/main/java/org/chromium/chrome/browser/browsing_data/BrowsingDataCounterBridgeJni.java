...
class BrowsingDataCounterBridgeJni implements BrowsingDataCounterBridge.Natives {
  private static BrowsingDataCounterBridge.Natives testInstance;

  public static final JniStaticTestMocker<BrowsingDataCounterBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<BrowsingDataCounterBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        BrowsingDataCounterBridge.Natives instance) {
