...
class ConnectionInfoViewJni implements ConnectionInfoView.Natives {
  ...
  public static final JniStaticTestMocker<ConnectionInfoView.Natives> TEST_HOOKS = new JniStaticTestMocker<ConnectionInfoView.Natives>() {
    @Override
    public void setInstanceForTesting(
        ConnectionInfoView.Natives instance) {
