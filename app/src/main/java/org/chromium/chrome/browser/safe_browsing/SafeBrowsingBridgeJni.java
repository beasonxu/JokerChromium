...
class SafeBrowsingBridgeJni implements SafeBrowsingBridge.Natives {
  ...
  public static final JniStaticTestMocker<SafeBrowsingBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<SafeBrowsingBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        SafeBrowsingBridge.Natives instance) {
