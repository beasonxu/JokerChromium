...
class InstantAppsInfoBarDelegateJni implements InstantAppsInfoBarDelegate.Natives {
  private static InstantAppsInfoBarDelegate.Natives testInstance;

  public static final JniStaticTestMocker<InstantAppsInfoBarDelegate.Natives> TEST_HOOKS = new JniStaticTestMocker<InstantAppsInfoBarDelegate.Natives>() {
    @Override
    public void setInstanceForTesting(
        InstantAppsInfoBarDelegate.Natives instance) {
