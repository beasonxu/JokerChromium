...
public class SendTabToSelfAndroidBridgeJni implements SendTabToSelfAndroidBridge.Natives {
  ...
  public static final JniStaticTestMocker<SendTabToSelfAndroidBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<SendTabToSelfAndroidBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        SendTabToSelfAndroidBridge.Natives instance) {
