...
class NotificationSuspenderJni implements NotificationSuspender.Natives {
  ...
  public static final JniStaticTestMocker<NotificationSuspender.Natives> TEST_HOOKS = new JniStaticTestMocker<NotificationSuspender.Natives>() {
    @Override
    public void setInstanceForTesting(
        NotificationSuspender.Natives instance) {
