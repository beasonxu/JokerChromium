...
class BrowserMediaRouterDialogControllerJni implements BrowserMediaRouterDialogController.Natives {
  ...
  public static final JniStaticTestMocker<BrowserMediaRouterDialogController.Natives> TEST_HOOKS = new JniStaticTestMocker<BrowserMediaRouterDialogController.Natives>() {
    @Override
    public void setInstanceForTesting(
        BrowserMediaRouterDialogController.Natives instance) {
