...
class LayerTitleCacheJni implements LayerTitleCache.Natives {
  ...
  public static final JniStaticTestMocker<LayerTitleCache.Natives> TEST_HOOKS = new JniStaticTestMocker<LayerTitleCache.Natives>() {
    @Override
    public void setInstanceForTesting(
        LayerTitleCache.Natives instance) {
