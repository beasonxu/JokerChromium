...
class ScrollingBottomViewSceneLayerJni implements ScrollingBottomViewSceneLayer.Natives {
  ...
  public static final JniStaticTestMocker<ScrollingBottomViewSceneLayer.Natives> TEST_HOOKS = new JniStaticTestMocker<ScrollingBottomViewSceneLayer.Natives>() {
    @Override
    public void setInstanceForTesting(
        ScrollingBottomViewSceneLayer.Natives instance) {
