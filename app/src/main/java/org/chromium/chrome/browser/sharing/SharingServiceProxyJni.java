...
class SharingServiceProxyJni implements SharingServiceProxy.Natives {
  ...
  public static final JniStaticTestMocker<SharingServiceProxy.Natives> TEST_HOOKS = new JniStaticTestMocker<SharingServiceProxy.Natives>() {
    @Override
    public void setInstanceForTesting(
        SharingServiceProxy.Natives instance) {
