...
org.chromium.mojo.bindings.AssociatedInterfaceNotSupported serviceWorkerHost, ServiceWorkerRegistrationObjectInfo registrationInfo, ServiceWorkerObjectInfo serviceWorkerInfo, int fetchHandlerExistence, org.chromium.mojo.bindings.InterfaceRequest<ReportingObserver> reportingObserverReceiver) {
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case INITIALIZE_GLOBAL_SCOPE_ORDINAL: {
                        ...
                        getImpl().initializeGlobalScope(data.serviceWorkerHost, data.registrationInfo, data.serviceWorkerInfo, data.fetchHandlerExistence, data.reportingObserverReceiver);
                        return true;
                    }
