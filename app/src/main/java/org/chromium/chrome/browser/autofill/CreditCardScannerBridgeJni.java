...
class CreditCardScannerBridgeJni implements CreditCardScannerBridge.Natives {
  ...
  public static final JniStaticTestMocker<CreditCardScannerBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<CreditCardScannerBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        CreditCardScannerBridge.Natives instance) {
