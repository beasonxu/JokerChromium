...
class JsonSanitizerJni implements JsonSanitizer.Natives {
  private static JsonSanitizer.Natives testInstance;

  public static final JniStaticTestMocker<JsonSanitizer.Natives> TEST_HOOKS = new JniStaticTestMocker<JsonSanitizer.Natives>() {
    @Override
    public void setInstanceForTesting(
        JsonSanitizer.Natives instance) {
