...
class TopToolbarSceneLayerJni implements TopToolbarSceneLayer.Natives {
  ...
  public static final JniStaticTestMocker<TopToolbarSceneLayer.Natives> TEST_HOOKS = new JniStaticTestMocker<TopToolbarSceneLayer.Natives>() {
    @Override
    public void setInstanceForTesting(
        TopToolbarSceneLayer.Natives instance) {
