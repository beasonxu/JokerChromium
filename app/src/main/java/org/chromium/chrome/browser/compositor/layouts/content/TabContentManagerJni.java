...
class TabContentManagerJni implements TabContentManager.Natives {
  ...
  public static final JniStaticTestMocker<TabContentManager.Natives> TEST_HOOKS = new JniStaticTestMocker<TabContentManager.Natives>() {
    @Override
    public void setInstanceForTesting(
        TabContentManager.Natives instance) {
