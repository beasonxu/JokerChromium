...
class StaticTabSceneLayerJni implements StaticTabSceneLayer.Natives {
  ...
  public static final JniStaticTestMocker<StaticTabSceneLayer.Natives> TEST_HOOKS = new JniStaticTestMocker<StaticTabSceneLayer.Natives>() {
    @Override
    public void setInstanceForTesting(
        StaticTabSceneLayer.Natives instance) {
