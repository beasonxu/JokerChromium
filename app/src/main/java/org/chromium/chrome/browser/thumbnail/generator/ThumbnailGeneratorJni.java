...
class ThumbnailGeneratorJni implements ThumbnailGenerator.Natives {
  private static ThumbnailGenerator.Natives testInstance;

  public static final JniStaticTestMocker<ThumbnailGenerator.Natives> TEST_HOOKS = new JniStaticTestMocker<ThumbnailGenerator.Natives>() {
    @Override
    public void setInstanceForTesting(
        ThumbnailGenerator.Natives instance) {
