...
class SiteEngagementServiceJni implements SiteEngagementService.Natives {
  ...
  public static final JniStaticTestMocker<SiteEngagementService.Natives> TEST_HOOKS = new JniStaticTestMocker<SiteEngagementService.Natives>() {
    @Override
    public void setInstanceForTesting(
        SiteEngagementService.Natives instance) {
