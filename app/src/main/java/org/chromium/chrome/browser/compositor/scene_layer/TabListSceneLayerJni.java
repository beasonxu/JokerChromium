...
class TabListSceneLayerJni implements TabListSceneLayer.Natives {
  ...
  public static final JniStaticTestMocker<TabListSceneLayer.Natives> TEST_HOOKS = new JniStaticTestMocker<TabListSceneLayer.Natives>() {
    @Override
    public void setInstanceForTesting(
        TabListSceneLayer.Natives instance) {
