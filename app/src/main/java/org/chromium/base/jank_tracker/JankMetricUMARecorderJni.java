...
class JankMetricUMARecorderJni implements JankMetricUMARecorder.Natives {
  ...
  public static final JniStaticTestMocker<JankMetricUMARecorder.Natives> TEST_HOOKS = new JniStaticTestMocker<JankMetricUMARecorder.Natives>() {
    ...
    public void setInstanceForTesting(
        JankMetricUMARecorder.Natives instance) {
  ...
  @Override
  public void recordJankMetrics(String scenarioName, long[] timestampsNs, long[] durationsNs,
      long[] jankBurstsNs, int missedFrames) {
    GEN_JNI.org_chromium_base_jank_1tracker_JankMetricUMARecorder_recordJankMetrics(scenarioName, timestampsNs, durationsNs, jankBurstsNs, missedFrames);
  }
