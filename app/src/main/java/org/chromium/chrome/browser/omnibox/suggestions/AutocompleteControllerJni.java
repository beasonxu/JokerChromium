...
public class AutocompleteControllerJni implements AutocompleteController.Natives {
  ...
  public static final JniStaticTestMocker<AutocompleteController.Natives> TEST_HOOKS = new JniStaticTestMocker<AutocompleteController.Natives>() {
    @Override
    public void setInstanceForTesting(
        AutocompleteController.Natives instance) {
