...
class TranslateCompactInfoBarJni implements TranslateCompactInfoBar.Natives {
  ...
  public static final JniStaticTestMocker<TranslateCompactInfoBar.Natives> TEST_HOOKS = new JniStaticTestMocker<TranslateCompactInfoBar.Natives>() {
    @Override
    public void setInstanceForTesting(
        TranslateCompactInfoBar.Natives instance) {
