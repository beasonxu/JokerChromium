...
class InstallableAmbientBadgeInfoBarJni implements InstallableAmbientBadgeInfoBar.Natives {
  private static InstallableAmbientBadgeInfoBar.Natives testInstance;

  public static final JniStaticTestMocker<InstallableAmbientBadgeInfoBar.Natives> TEST_HOOKS = new JniStaticTestMocker<InstallableAmbientBadgeInfoBar.Natives>() {
    @Override
    public void setInstanceForTesting(
        InstallableAmbientBadgeInfoBar.Natives instance) {
