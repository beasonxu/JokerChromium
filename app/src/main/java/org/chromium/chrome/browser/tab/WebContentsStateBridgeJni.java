...
public class WebContentsStateBridgeJni implements WebContentsStateBridge.Natives {
  ...
  public static final JniStaticTestMocker<WebContentsStateBridge.Natives> TEST_HOOKS = new JniStaticTestMocker<WebContentsStateBridge.Natives>() {
    @Override
    public void setInstanceForTesting(
        WebContentsStateBridge.Natives instance) {
