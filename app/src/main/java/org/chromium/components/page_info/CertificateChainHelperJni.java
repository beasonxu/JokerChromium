...
class CertificateChainHelperJni implements CertificateChainHelper.Natives {
  ...
  public static final JniStaticTestMocker<CertificateChainHelper.Natives> TEST_HOOKS = new JniStaticTestMocker<CertificateChainHelper.Natives>() {
    @Override
    public void setInstanceForTesting(
        CertificateChainHelper.Natives instance) {
